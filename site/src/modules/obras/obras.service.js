...
export const ObrasService = {
    ...
    calculateFinancialSummary: async (obraId, compras = [], rdoData = null, opts = {}) => {
        ...
        const laborPlanned = (horasNormaisPrev * costHour) + (horasExtrasPrev * costOver * extraFactor);
        ...
        const laborSpent = (horasNormaisExec * costHour) + (horasExtrasExec * costOver * extraFactor);
