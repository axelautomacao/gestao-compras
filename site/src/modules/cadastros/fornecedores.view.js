                ...
                <div class="overflow-x-auto">
                    <table id="fornecedor-table" class="min-w-full divide-y divide-border">
                        ...
                        <tbody class="divide-y divide-border">
                            ${fornecedores.map(f => `
                                <tr data-id="${f.id}" data-nome="${f.nome || ''}" data-email="${f.email || ''}" data-telefone="${f.telefone || ''}" data-cnpj="${f.cnpj || ''}">
                                    <td class="px-4 py-2 text-sm text-text">${f.nome || '-'}</td>
                                    <td class="px-4 py-2 text-sm text-text-muted">${f.telefone || '-'}</td>
                                    <td class="px-4 py-2 text-sm text-text-muted">${f.email || '-'}</td>
