 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fs=new ju("@firebase/firestore");function nr(){return Fs.logLevel}function W(n,...t){if(Fs.logLevel<=dt.DEBUG){const e=t.map(qu);Fs.debug(`Firestore (${Li}): ${n}`,...e)}}function Rn(n,...t){if(Fs.logLevel<=dt.ERROR){const e=t.map(qu);Fs.error(`Firestore (${Li}): ${n}`,...e)}}function Ei(n,...t){if(Fs.logLevel<=dt.WARN){const e=t.map(qu);Fs.warn(`Firestore (${Li}): ${n}`,...e)}}function qu(n){if(typeof n=="string")return n;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class id{constructor(){this.Tr=new ue(se.Er),this.dr=new ue(se.Ar)}isEmpty(){return this.Tr.isEmpty()}addReference(t,e){const s=new se(t,e);this.Tr=this.Tr.add(s),this.dr=this.dr.add(s)}Rr(t,e){t.forEach(s=>this.addReference(s,e))}removeReference(t,e){this.Vr(new se(t,e))}mr(t,e){t.forEach(s=>this.removeReference(s,e))}gr(t){const e=new G(new Pt([])),s=new se(e,t),i=new se(e,t+1),r=[];return this.dr.forEachInRange([s,i],o=>{this.Vr(o),r.push(o.key)}),r}pr(){this.Tr.forEach(t=>this.Vr(t))}Vr(t){this.Tr=this.Tr.delete(t),this.dr=this.dr.delete(t)}yr(t){const e=new G(new Pt([])),s=new se(e,t),i=new se(e,t+1);let r=ct();return this.dr.forEachInRange([s,i],o=>{r=r.add(o.key)}),r}containsKey(t){const e=new se(t,0),s=this.Tr.firstAfterOrEqual(e);return s!==null&&t.isEqual(s.key)}}class se{constructor(t,e){this.key=t,this.wr=e}static Er(t,e){return G.comparator(t.key,e.key)||gt(t.wr,e.wr)}static Ar(t,e){return gt(t.wr,e.wr)||G.comparator(t.key,e.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gE{constructor(){this.Gi=!1,this.zi=!1,this.ji=100,this.Hi=function(){return _x()?8:Q0(Ee())>0?6:4}()}initialize(t,e){this.Ji=t,this.indexManager=e,this.Gi=!0}getDocumentsMatchingQuery(t,e,s,i){const r={result:null};return this.Yi(t,e).next(o=>{r.result=o}).next(()=>{if(!r.result)return this.Zi(t,e,i,s).next(o=>{r.result=o})}).next(()=>{if(r.result)return;const o=new mE;return this.Xi(t,e,o).next(a=>{if(r.result=a,this.zi)return this.es(t,e,o,a.size)})}).next(()=>r.result)}es(t,e,s,i){return s.documentReadCount<this.ji?(nr()<=dt.DEBUG&&W("QueryEngine","SDK will not create cache indexes for query:",ui(e),"since it only creates cache indexes for collection contains","more than or equal to",this.ji,"documents"),$.resolve()):(nr()<=dt.DEBUG&&W("QueryEngine","Query:",ui(e),"scans",s.documentReadCount,"local documents and returns",i,"documents as results."),s.documentReadCount>this.Hi*i?(nr()<=dt.DEBUG&&W("QueryEngine","The SDK decides to create cache indexes for query:",ui(e),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(t,sn(e))):$.resolve())}Yi(t,e){if(Df(e))return $.resolve(null);let s=sn(e);return this.indexManager.getIndexType(t,s).next(i=>i===0?null:(e.limit!==null&&i===1&&(e=Ma(e,null,"F"),s=sn(e)),this.indexManager.getDocumentsMatchingTarget(t,s).next(r=>{const o=ct(...r);return this.Ji.getDocuments(t,o).next(a=>this.indexManager.getMinOffset(t,s).next(c=>{const l=this.ts(e,a);return this.ns(e,l,o,c.readTime)?this.Yi(t,Ma(e,null,"F")):this.rs(t,l,e,c)}))})))}Zi(t,e,s,i){return Df(e)||i.isEqual(Z.min())?$.resolve(null):this.Ji.getDocuments(t,s).next(r=>{const o=this.ts(e,r);return this.ns(e,o,s,i)?$.resolve(null):(nr()<=dt.DEBUG&&W("QueryEngine","Re-using previous result from %s to execute query: %s",i.toString(),ui(e)),this.rs(t,o,e,q0(i,-1)).next(a=>a))})}ts(t,e){let s=new ue(Wg(t));return e.forEach((i,r)=>{dc(t,r)&&(s=s.add(r))}),s}ns(t,e,s,i){if(t.limit===null)return!1;if(s.size!==e.size)return!0;const r=t.limitType==="F"?e.last():e.first();return!!r&&(r.hasPendingWrites||r.version.compareTo(i)>0)}Xi(t,e,s){return nr()<=dt.DEBUG&&W("QueryEngine","Using full collection scan to execute query:",ui(e)),this.Ji.getDocumentsMatchingQuery(t,e,ss.min(),s)}rs(t,e,s,i){return this.Ji.getDocumentsMatchingQuery(t,s,i).next(r=>(e.forEach(o=>{r=r.insert(o.key,o)}),r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yi{constructor(t){this.comparator=t?(e,s)=>t(e,s)||G.comparator(e.key,s.key):(e,s)=>G.comparator(e.key,s.key),this.keyedMap=_r(),this.sortedSet=new $t(this.comparator)}static emptySet(t){return new yi(t.comparator)}has(t){return this.keyedMap.get(t)!=null}get(t){return this.keyedMap.get(t)}first(){return this.sortedSet.minKey()}last(){return this.sortedSet.maxKey()}isEmpty(){return this.sortedSet.isEmpty()}indexOf(t){const e=this.keyedMap.get(t);return e?this.sortedSet.indexOf(e):-1}get size(){return this.sortedSet.size}forEach(t){this.sortedSet.inorderTraversal((e,s)=>(t(e),!1))}add(t){const e=this.delete(t.key);return e.copy(e.keyedMap.insert(t.key,t),e.sortedSet.insert(t,null))}delete(t){const e=this.get(t);return e?this.copy(this.keyedMap.remove(t),this.sortedSet.remove(e)):this}isEqual(t){if(!(t instanceof yi)||this.size!==t.size)return!1;const e=this.sortedSet.getIterator(),s=t.sortedSet.getIterator();for(;e.hasNext();){const i=e.getNext().key,r=s.getNext().key;if(!i.isEqual(r))return!1}return!0}toString(){const t=[];return this.forEach(e=>{t.push(e.toString())}),t.length===0?"DocumentSet ()":`DocumentSet (
  `+t.join(`  
`)+`
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gf{constructor(){this.W_=new $t(G.comparator)}track(t){const e=t.doc.key,s=this.W_.get(e);s?t.type!==0&&s.type===3?this.W_=this.W_.insert(e,t):t.type===3&&s.type!==1?this.W_=this.W_.insert(e,{type:s.type,doc:t.doc}):t.type===2&&s.type===2?this.W_=this.W_.insert(e,{type:2,doc:t.doc}):t.type===2&&s.type===0?this.W_=this.W_.insert(e,{type:0,doc:t.doc}):t.type===1&&s.type===0?this.W_=this.W_.remove(e):t.type===1&&s.type===2?this.W_=this.W_.insert(e,{type:1,doc:s.doc}):t.type===0&&s.type===1?this.W_=this.W_.insert(e,{type:2,doc:t.doc}):J():this.W_=this.W_.insert(e,t)}G_(){const t=[];return this.W_.inorderTraversal((e,s)=>{t.push(s)}),t}}class Si{constructor(t,e,s,i,r,o,a,c,l){this.query=t,this.docs=e,this.oldDocs=s,this.docChanges=i,this.mutatedKeys=r,this.fromCache=o,this.syncStateChanged=a,this.excludesMetadataChanges=c,this.hasCachedResults=l}static fromInitialDocuments(t,e,s,i,r){const o=[];return e.forEach(a=>{o.push({type:0,doc:a})}),new Si(t,e,yi.emptySet(e),o,s,i,!0,!1,r)}get hasPendingWrites(){return!this.mutatedKeys.isEmpty()}isEqual(t){if(!(this.fromCache===t.fromCache&&this.hasCachedResults===t.hasCachedResults&&this.syncStateChanged===t.syncStateChanged&&this.mutatedKeys.isEqual(t.mutatedKeys)&&uc(this.query,t.query)&&this.docs.isEqual(t.docs)&&this.oldDocs.isEqual(t.oldDocs)))return!1;const e=this.docChanges,s=t.docChanges;if(e.length!==s.length)return!1;for(let i=0;i<e.length;i++)if(e[i].type!==s[i].type||!e[i].doc.isEqual(s[i].doc))return!1;return!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const za=new ju("@firebase/auth");function ZI(n,...t){za.logLevel<=dt.WARN&&za.warn(`Auth (${qs}): ${n}`,...t)}function ga(n,...t){za.logLevel<=dt.ERROR&&za.error(`Auth (${qs}): ${n}`,...t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function My(n,t=[]){let e;switch(n){case"Browser":e=_p(Ee());break;case"Worker":e=`${_p(Ee())}-${n}`;break;default:e=n}const s=t.length?t.join(","):"FirebaseCore-web";return`${e}/JsCore/${qs}/${s}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`);const a=new Blob([o],{type:"text/csv;charset=utf-8;"}),c=URL.createObjectURL(a),l=document.createElement("a");l.href=c,l.download=`compras_${n}_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(l),l.click(),document.body.removeChild(l),URL.revokeObjectURL(c)}},ug={getUsers:async()=>(await mt(yt(K,"usuarios"))).docs.map(t=>({id:t.id,...t.data()})),updateUser:async(n,t)=>{await He(ne(K,"usuarios",n),t)},createUserProfile:async(n,t)=>{await NT(ne(K,"usuarios",n),t)}},vM={render:n=>`
    ...
    `},Uu={init:async()=>{const n=await Ns.list();at.render(SM.render(n)),Uu.bind()},bind:()=>{const n=document.getElementById("comprador-form"),t=document.getElementById("btn-novo-comprador"),e=document.getElementById("btn-salvar-comprador"),s=document.getElementById("btn-cancelar-comprador"),i=document.getElementById("compr-table");let r=null;t==null||t.addEventListener("click",()=>n==null?void 0:n.classList.remove("hidden")),s==null||s.addEventListener("click",()=>n==null?void 0:n.classList.add("hidden")),e==null||e.addEventListener("click",async()=>{const o={nome:document.getElementById("compr-nome").value,email:document.getElementById("compr-email").value};r?await Ns.update(r,o):await Ns.create(o),Uu.init()}),i==null||i.addEventListener("click",o=>{const a=o.target.closest("tr[data-id]");a&&(r=a.dataset.id,document.getElementById("compr-nome").value=a.dataset.nome||"",document.getElementById("compr-email").value=a.dataset.email||"",n==null||n.classList.remove("hidden"))})}},fg={renderBell:(n=0)=>`
        ...
        `},ae={notifications:[],unreadCount:0,eventsBound:!1,init:async()=>{Et.state.currentUser&&(window.addEventListener("layout:rendered",()=>{ae.render(),ae.bindEvents()}),await ae.load(),ae.render(),ae.bindEvents(),setInterval(()=>ae.load(),12e4))},load:async()=>{const n=Et.state.currentUser;ae.notifications=await Ni.getByUser(n.uid,20),ae.unreadCount=ae.notifications.filter(t=>!t.lida).length,ae.render(),lh.badge(ae.unreadCount)},render:()=>{const n=document.getElementById("notifications-container");if(!n)return;n.innerHTML=fg.renderBell(ae.unreadCount);const t=document.createElement("div");t.className="relative",t.innerHTML=fg.renderDropdown(ae.notifications),n.appendChild(t)},bindEvents:()=>{ae.eventsBound||(ae.eventsBound=!0,document.addEventListener("click",n=>{const t=document.getElementById("notifications-bell"),e=document.getElementById("notifications-dropdown");t&&t.contains(n.target)?e==null||e.classList.toggle("hidden"):e&&!e.contains(n.target)&&e.classList.add("hidden")}),document.addEventListener("click",async n=>{if(n.target.id==="mark-all-read"){const t=Et.state.currentUser;await Ni.markAllAsRead(t.uid),await ae.load()}}))}};console.log("[Main] Inicializando aplicação...");const CM=async()=>{try{await yS(),console.log("[Main] Firebase inicializado."),Et.applyTheme(Et.state.currentTheme||"dark"),await Ya.init(),Et.state.currentUser&&await ae.init(),At.init(),At.on("/",xb.init),At.on("/login",Dp.initLogin),At.on("/forgot-password",Dp.initForgotPassword),At.on("/compras",oc.init),At.on("/relatorios",U.init),At.on("/configuracoes",Fu.init),At.on("/compras/:id/editar",({id:t})=>oc.initEdit(t)),At.on("/cadastros",IM.init),At.on("/cadastros/fornecedores",$u.init),At.on("/cadastros/centros-custo",Bu.init),At.on("/cadastros/compradores",Uu.init),At.on("/obras",mi.initList),At.on("/obras/nova",()=>mi.initForm()),At.on("/obras/:id",({id:t})=>mi.initDashboard(t)),At.on("/obras/:id/dashboard",({id:t})=>mi.initDashboard(t)),At.on("/obras/:id/editar",({id:t})=>mi.initForm(t)),At.handleRoute();const n=document.getElementById("loader");n&&n.remove()}catch(n){console.error("[Main] Erro fatal:",n),document.body.innerHTML=`<div class="p-10 text-red-600">Erro fatal: ${n.message}</div>`}};CM();
