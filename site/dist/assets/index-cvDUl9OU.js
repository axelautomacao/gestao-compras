...
*/var rs,pg;(function(){var n;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function t(E,b){function x(){}x.prototype=b.prototype,E.D=b.prototype,E.prototype=new x,E.prototype.constructor=E,E.C=function(I,S,k){for(var T=Array(arguments.length-2),bt=2;bt<arguments.length;bt++)T[bt-2]=arguments[bt];return b.prototype[S].apply(I,T)}}function e(){this.blockSize=-1}function s(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}t(s,e),s.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function i(E,b,x){x||(x=0);var I=Array(16);if(typeof b=="string")for(var S=0;16>S;++S)I[S]=b.charCodeAt(x++)|b.charCodeAt(x++)<<8|b.charCodeAt(x++)<<16|b.charCodeAt(x++)<<24;else for(S=0;16>S;++S)I[S]=b[x++]|b[x++]<<8|b[x++]<<16|b[x++]<<24;b=E.g[0],x=E.g[1],S=E.g[2];var k=E.g[3],T=b+(k^x&(S^k))+I[0]+3614090360&4294967295;b=x+(T<<7&4294967295|T>>>25),T=k+(S^b&(x^S))+I[1]+3905402710&4294967295,k=b+(T<<12&4294967295|T>>>20),T=S+(x^k&(b^x))+I[2]+606105819&4294967295,S=k+(T<<17&4294967295|T>>>15),T=x+(b^S&(k^b))+I[3]+3250441966&4294967295,x=S+(T<<22&4294967295|T>>>10),T=b+(k^x&(S^k))+I[4]+4118548399&4294967295,b=x+(T<<7&4294967295|T>>>25),T=k+(S^b&(x^S))+I[5]+1200080426&4294967295,k=b+(T<<12&4294967295|T>>>20),T=S+(x^k&(b^x))+I[6]+2821735955&4294967295,S=k+(T<<17&4294967295|T>>>15),T=x+(b^S&(k^b))+I[7]+4249261313&4294967295,x=S+(T<<22&4294967295|T>>>10),T=b+(k^x&(S^k))+I[8]+1770035416&4294967295,b=x+(T<<7&4294967295|T>>>25),T=k+(S^b&(x^S))+I[9]+2336552879&4294967295,k=b+(T<<12&4294967295|T>>>20),T=S+(x^k&(b^x))+I[10]+4294925233&4294967295,S=k+(T<<17&4294967295|T>>>15),T=x+(b^S&(k^b))+I[11]+2304563134&4294967295,x=S+(T<<22&4294967295|T>>>10),T=b+(k^x&(S^k))+I[12]+1804603682&4294967295,b=x+(T<<7&4294967295|T>>>25),T=k+(S^b&(x^S))+I[13]+4254626195&4294967295,k=b+(T<<12&4294967295|T>>>20),T=S+(x^k&(b^x))+I[14]+2792965006&4294967295,S=k+(T<<17&4294967295|T>>>15),T=x+(b^S&(k^b))+I[15]+1236535329&4294967295,x=S+(T<<22&4294967295|T>>>10),T=b+(S^k&(x^S))+I[1]+4129170786&4294967295,b=x+(T<<5&4294967295|T>>>27),T=k+(x^S&(b^x))+I[6]+3225465664&4294967295,k=b+(T<<9&4294967295|T>>>23),T=S+(b^x&(k^b))+I[11]+643717713&4294967295,S=k+(T<<14&4294967295|T>>>18),T=x+(k^b&(S^k))+I[0]+3921069994&4294967295,x=S+(T<<20&4294967295|T>>>12),T=b+(S^k&(x^S))+I[5]+3593408605&4294967295,b=x+(T<<5&4294967295|T>>>27),T=k+(x^S&(b^x))+I[10]+38016083&4294967295,k=b+(T<<9&4294967295|T>>>23),T=S+(b^x&(k^b))+I[15]+3634488961&4294967295,S=k+(T<<14&4294967295|T>>>18),T=x+(k^b&(S^k))+I[4]+3889429448&4294967295,x=S+(T<<20&4294967295|T>>>12),T=b+(S^k&(x^S))+I[9]+568446438&4294967295,b=x+(T<<5&4294967295|T>>>27),T=k+(x^S&(b^x))+I[14]+3275163606&4294967295,k=b+(T<<9&4294967295|T>>>23),T=S+(b^x&(k^b))+I[3]+4107603335&4294967295,S=k+(T<<14&4294967295|T>>>18),T=x+(k^b&(S^k))+I[8]+1163531501&4294967295,x=S+(T<<20&4294967295|T>>>12),T=b+(S^k&(x^S))+I[13]+2850285829&4294967295,b=x+(T<<5&4294967295|T>>>27),T=k+(x^S&(b^x))+I[2]+4243563512&4294967295,k=b+(T<<9&4294967295|T>>>23),T=S+(b^x&(k^b))+I[7]+1735328473&4294967295,S=k+(T<<14&4294967295|T>>>18),T=x+(k^b&(S^k))+I[12]+2368359562&4294967295,x=S+(T<<20&4294967295|T>>>12),T=b+(x^S^k)+I[5]+4294588738&4294967295,b=x+(T<<4&4294967295|T>>>28),T=k+(b^x^S)+I[8]+2272392833&4294967295,k=b+(T<<11&4294967295|T>>>21),T=S+(k^b^x)+I[11]+1839030562&4294967295,S=k+(T<<16&4294967295|T>>>16),T=x+(S^k^b)+I[14]+4259657740&4294967295,x=S+(T<<23&4294967295|T>>>9),T=b+(x^S^k)+I[1]+2763975236&4294967295,b=x+(T<<4&4294967295|T>>>28),T=k+(b^x^S)+I[4]+1272893353&4294967295,k=b+(T<<11&4294967295|T>>>21),T=S+(k^b^x)+I[7]+4139469664&4294967295,S=k+(T<<16&4294967295|T>>>16),T=x+(S^k^b)+I[10]+3200236656&4294967295,x=S+(T<<23&4294967295|T>>>9),T=b+(x^S^k)+I[13]+681279174&4294967295,b=x+(T<<4&4294967295|T>>>28),T=k+(b^x^S)+I[0]+3936430074&4294967295,k=b+(T<<11&4294967295|T>>>21),T=S+(k^b^x)+I[3]+3572445317&4294967295,S=k+(T<<16&4294967295|T>>>16),T=x+(S^k^b)+I[6]+76029189&4294967295,x=S+(T<<23&4294967295|T>>>9),T=b+(x^S^k)+I[9]+3654602809&4294967295,b=x+(T<<4&4294967295|T>>>28),T=k+(b^x^S)+I[12]+3873151461&4294967295,k=b+(T<<11&4294967295|T>>>21),T=S+(k^b^x)+I[15]+530742520&4294967295,S=k+(T<<16&4294967295|T>>>16),T=x+(S^k^b)+I[2]+3299628645&4294967295,x=S+(T<<23&4294967295|T>>>9),T=b+(S^(x|~k))+I[0]+4096336452&4294967295,b=x+(T<<6&4294967295|T>>>26),T=k+(x^(b|~S))+I[7]+1126891415&4294967295,k=b+(T<<10&4294967295|T>>>22),T=S+(b^(k|~x))+I[14]+2878612391&4294967295,S=k+(T<<15&4294967295|T>>>17),T=x+(k^(S|~b))+I[5]+4237533241&4294967295,x=S+(T<<21&4294967295|T>>>11),T=b+(S^(x|~k))+I[12]+1700485571&4294967295,b=x+(T<<6&4294967295|T>>>26),T=k+(x^(b|~S))+I[3]+2399980690&4294967295,k=b+(T<<10&4294967295|T>>>22),T=S+(b^(k|~x))+I[10]+4293915773&4294967295,S=k+(T<<15&4294967295|T>>>17),T=x+(k^(S|~b))+I[1]+2240044497&4294967295,x=S+(T<<21&4294967295|T>>>11),T=b+(S^(x|~k))+I[8]+1873313359&4294967295,b=x+(T<<6&4294967295|T>>>26),T=k+(x^(b|~S))+I[15]+4264355552&4294967295,k=b+(T<<10&4294967295|T>>>22),T=S+(b^(k|~x))+I[6]+2734768916&4294967295,S=k+(T<<15&4294967295|T>>>17),T=x+(k^(S|~b))+I[13]+1309151649&4294967295,x=S+(T<<21&4294967295|T>>>11),T=b+(S^(x|~k))+I[4]+4149444226&4294967295,b=x+(T<<6&4294967295|T>>>26),T=k+(x^(b|~S))+I[11]+3174756917&4294967295,k=b+(T<<10&4294967295|T>>>22),T=S+(b^(k|~x))+I[2]+718787259&4294967295,S=k+(T<<15&4294967295|T>>>17),T=x+(k^(S|~b))+I[9]+3951481745&4294967295,E.g[0]=E.g[0]+b&4294967295,E.g[1]=E.g[1]+(S+(T<<21&4294967295|T>>>11))&4294967295,E.g[2]=E.g[2]+S&4294967295,E.g[3]=E.g[3]+k&4294967295}s.prototype.u=function(E,b){b===void 0&&(b=E.length);for(var x=b-this.blockSize,I=this.B,S=this.h,k=0;k<b;){if(S==0)for(;k<=x;)i(this,E,k),k+=this.blockSize;if(typeof E=="string"){for(;k<b;)if(I[S++]=E.charCodeAt(k++),S==this.blockSize){i(this,I),S=0;break}}else for(;k<b;)if(I[S++]=E[k++],S==this.blockSize){i(this,I),S=0;break}}this.h=S,this.o+=b},s.prototype.v=function(){var E=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);E[0]=128;for(var b=1;b<E.length-8;++b)E[b]=0;var x=8*this.o;for(b=E.length-8;b<E.length;++b)E[b]=x&255,x/=256;for(this.u(E),E=Array(16),b=x=0;4>b;++b)for(var I=0;32>I;I+=8)E[x++]=this.g[b]>>>I&255;return E};function r(E,b){var x=a;return Object.prototype.hasOwnProperty.call(x,E)?x[E]:x[E]=b(E)}function o(E,b){this.h=b;for(var x=[],I=!0,S=E.length-1;0<=S;S--){var k=E[S]|0;I&&k==b||(x[S]=k,I=!1)}this.g=x}var a={};function l(E){return-128<=E&&128>E?r(E,function(b){return new o([b|0],0>b?-1:0)}):new o([E|0],0>E?-1:0)}function u(E){if(isNaN(E)||!isFinite(E))return d;if(0>E)return y(u(-E));for(var b=[],x=1,I=0;E>=x;I++)b[I]=E/x|0,x*=4294967296;return new o(b,0)}function h(E,b){if(E.length==0)throw Error("number format error: empty string");if(b=b||10,2>b||36<b)throw Error("radix out of range: "+b);if(E.charAt(0)=="-")return y(h(E.substring(1),b));if(0<=E.indexOf("-"))throw Error('number format error: interior "-" character');for(var x=u(Math.pow(b,8)),I=d,S=0;S<E.length;S+=8){var k=Math.min(8,E.length-S),T=parseInt(E.substring(S,S+k),b);8>k?(k=u(Math.pow(b,k)),I=I.j(k).add(u(T))):(I=I.j(x),I=I.add(u(T)))}return I}var d=l(0),p=l(1),m=l(16777216);n=o.prototype,n.m=function(){if(v(this))return-y(this).m();for(var E=0,b=1,x=0;x<this.g.length;x++){var I=this.i(x);E+=(0<=I?I:4294967296+I)*b,b*=4294967296}return E},n.toString=function(E){if(E=E||10,2>E||36<E)throw Error("radix out of range: "+E);if(_(this))return"0";if(v(this))return"-"+y(this).toString(E);for(var b=u(Math.pow(E,6)),x=this,I="";;){var S=P(x,b).g;x=A(x,S.j(b));var k=((0<x.g.length?x.g[0]:x.h)>>>0).toString(E);if(x=S,_(x))return k+I;for(;6>k.length;)k="0"+k;I=k+I}},n.i=function(E){return 0>E?0:E<this.g.length?this.g[E]:this.h};function _(E){if(E.h!=0)return!1;for(var b=0;b<E.g.length;b++)if(E.g[b]!=0)return!1;return!0}function v(E){return E.h==-1}n.l=function(E){return E=A(this,E),v(E)?-1:_(E)?0:1};function y(E){for(var b=E.g.length,x=[],I=0;I<b;I++)x[I]=~E.g[I];return new o(x,~E.h).add(p)}n.abs=function(){return v(this)?y(this):this},n.add=function(E){for(var b=Math.max(this.g.length,E.g.length),x=[],I=0,S=0;S<=b;S++){var k=I+(this.i(S)&65535)+(E.i(S)&65535),T=(k>>>16)+(this.i(S)>>>16)+(E.i(S)>>>16);I=T>>>16,k&=65535,T&=65535,x[S]=T<<16|k}return new o(x,x[x.length-1]&-2147483648?-1:0)};function A(E,b){return E.add(y(b))}n.j=function(E){if(_(this)||_(E))return d;if(v(this))return v(E)?y(this).j(y(E)):y(y(this).j(E));if(v(E))return y(this.j(y(E)));if(0>this.l(m)&&0>E.l(m))return u(this.m()*E.m());for(var b=this.g.length+E.g.length,x=[],I=0;I<2*b;I++)x[I]=0;for(I=0;I<this.g.length;I++)for(var S=0;S<E.g.length;S++){var k=this.i(I)>>>16,T=this.i(I)&65535,bt=E.i(S)>>>16,Z=E.i(S)&65535;x[2*I+2*S]+=T*Z,R(x,2*I+2*S),x[2*I+2*S+1]+=k*Z,R(x,2*I+2*S+1),x[2*I+2*S+1]+=T*bt,R(x,2*I+2*S+1),x[2*I+2*S+2]+=k*bt,R(x,2*I+2*S+2)}for(I=0;I<b;I++)x[I]=x[2*I+1]<<16|x[2*I];for(I=b;I<2*b;I++)x[I]=0;return new o(x,0)};function R(E,b){for(;(E[b]&65535)!=E[b];)E[b+1]+=E[b]>>>16,E[b]&=65535,b++}function D(E,b){this.g=E,this.h=b}function P(E,b){if(_(b))throw Error("division by zero");if(_(E))return new D(d,d);if(v(E))return b=P(y(E),b),new D(y(b.g),y(b.h));if(v(b))return b=P(E,y(b)),new D(y(b.g),b.h);if(30<E.g.length){if(v(E)||v(b))throw Error("slowDivide_ only works with positive integers.");for(var x=p,I=b;0>=I.l(E);)x=O(x),I=O(I);var S=L(x,1),k=L(I,1);for(I=L(I,2),x=L(x,2);!_(I);){var T=k.add(I);0>=T.l(E)&&(S=S.add(x),k=T),I=L(I,1),x=L(x,1)}return b=A(E,S.j(b)),new D(S,b)}for(S=d;0<=E.l(b);){for(x=Math.max(1,Math.floor(E.m()/b.m())),I=Math.ceil(Math.log(x)/Math.LN2),I=48>=I?1:Math.pow(2,I-48),k=u(x),T=k.j(b);v(T)||0<T.l(E);)x-=I,k=u(x),T=k.j(b);_(k)&&(k=p),S=S.add(k),E=A(E,T)}return new D(S,E)}n.A=function(E){return P(this,E).h},n.and=function(E){for(var b=Math.max(this.g.length,E.g.length),x=[],I=0;I<b;I++)x[I]=this.i(I)&E.i(I);return new o(x,this.h&E.h)},n.or=function(E){for(var b=Math.max(this.g.length,E.g.length),x=[],I=0;I<b;I++)x[I]=this.i(I)|E.i(I);return new o(x,this.h|E.h)},n.xor=function(E){for(var b=Math.max(this.g.length,E.g.length),x=[],I=0;I<b;I++)x[I]=this.i(I)^E.i(I);return new o(x,this.h^E.h)};function O(E){for(var b=E.g.length+1,x=[],I=0;I<b;I++)x[I]=E.i(I)<<1|E.i(I-1)>>>31;return new o(x,E.h)}function L(E,b){var x=b>>5;b%=32;for(var I=E.g.length-x,S=[],k=0;k<I;k++)S[k]=0<b?E.i(k+x)>>>b|E.i(k+x+1)<<32-b:E.i(k+x);return new o(S,E.h)}s.prototype.digest=s.prototype.v,s.prototype.reset=s.prototype.s,s.prototype.update=s.prototype.u,pg=s,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.A,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=u,o.fromString=h,rs=o}).apply(typeof fd<"u"?fd:typeof self<"u"?self:typeof window<"u"?window:{});var Jr=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class te{constructor(t,e,s,i,r,o,a){this.key=t,this.documentType=e,this.version=s,this.readTime=i,this.createTime=r,this.data=o,this.documentState=a}static newInvalidDocument(t){return new te(t,0,q.min(),q.min(),q.min(),fe.empty(),0)}static newFoundDocument(t,e,s,i){return new te(t,1,e,q.min(),s,i,0)}static newNoDocument(t,e){return new te(t,2,e,q.min(),q.min(),fe.empty(),0)}static newUnknownDocument(t,e){return new te(t,3,e,q.min(),q.min(),fe.empty(),2)}convertToFoundDocument(t,e){return!this.createTime.isEqual(q.min())||this.documentType!==2&&this.documentType!==0||(this.createTime=t),this.version=t,this.documentType=1,this.data=e,this.documentState=0,this}convertToNoDocument(t){return this.version=t,this.documentType=2,this.data=fe.empty(),this.documentState=0,this}convertToUnknownDocument(t){return this.version=t,this.documentType=3,this.data=fe.empty(),this.documentState=2,this}setHasCommittedMutations(){return this.documentState=2,this}setHasLocalMutations(){return this.documentState=1,this.version=q.min(),this}setReadTime(t){return this.readTime=t,this}get hasLocalMutations(){return this.documentState===1}get hasCommittedMutations(){return this.documentState===2}get hasPendingWrites(){return this.hasLocalMutations||this.hasCommittedMutations}isValidDocument(){return this.documentType!==0}isFoundDocument(){return this.documentType===1}isNoDocument(){return this.documentType===2}isUnknownDocument(){return this.documentType===3}isEqual(t){return t instanceof te&&this.key.isEqual(t.key)&&this.version.isEqual(t.version)&&this.documentType===t.documentType&&this.documentState===t.documentState&&this.data.isEqual(t.data)}mutableCopy(){return new te(this.key,this.documentType,this.version,this.readTime,this.createTime,this.data.clone(),this.documentState)}toString(){return`Document(${this.key}, ${this.version}, ${JSON.stringify(this.data.value)}, {createTime: ${this.createTime}}), {documentType: ${this.documentType}}), {documentState: ${this.documentState}})`}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ve{constructor(t,e){this.bucket=t,this.path_=e}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const t=encodeURIComponent;return"/b/"+t(this.bucket)+"/o/"+t(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(t,e){let s;try{s=ve.makeFromUrl(t,e)}catch{return new ve(t,"")}if(s.path==="")return s;throw rE(t)}static makeFromUrl(t,e){let s=null;const i="([A-Za-z0-9.\\-_]+)";function r(P){P.path.charAt(P.path.length-1)==="/"&&(P.path_=P.path_.slice(0,-1))}const o="(/(.*))?$",a=new RegExp("^gs://"+i+o,"i"),l={bucket:1,path:3};function u(P){P.path_=decodeURIComponent(P.path)}const h="v[A-Za-z0-9_]+",d=e.replace(/[.]/g,"\\."),p="(/([^?#]*).*)?$",m=new RegExp(`^https?://${d}/${h}/b/${i}/o${p}`,"i"),_={bucket:1,path:3},v=e===Vm?"(?:storage.googleapis.com|storage.cloud.google.com)":e,y="([^?#]*)",A=new RegExp(`^https?://${v}/${i}/${y}`,"i"),D=[{regex:a,indices:l,postModify:r},{regex:m,indices:_,postModify:u},{regex:A,indices:{bucket:1,path:2},postModify:u}];for(let P=0;P<D.length;P++){const O=D[P],L=O.regex.exec(t);if(L){const E=L[O.indices.bucket];let b=L[O.indices.path];b||(b=""),s=new ve(E,b),O.postModify(s);break}}if(s==null)throw iE(t);return s}}class hE{constructor(t){this.promise_=Promise.reject(t)}getPromise(){return this.promise_}cancel(t=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dE(n,t,e){let s=1,i=null,r=null,o=!1,a=0;function l(){return a===2}let u=!1;function h(...y){u||(u=!0,t.apply(null,y))}function d(y){i=setTimeout(()=>{i=null,n(m,l())},y)}function p(){r&&clearTimeout(r)}function m(y,...A){if(u){p();return}if(y){p(),h.call(null,y,...A);return}if(l()||o){p(),h.call(null,y,...A);return}s<64&&(s*=2);let D;a===1?(a=2,D=0):D=(s+Math.random())*1e3,d(D)}let _=!1;function v(y){_||(_=!0,p(),!u&&(i!==null?(y||(a=2),clearTimeout(i),d(0)):y||(a=1)))}return d(0),r=setTimeout(()=>{o=!0,v(!0)},e),v}function fE(n){n(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
        ...
        `,renderDiretor:n=>`
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
                    ${U.createCard({title:"Total Gasto (Amostra)",content:`<p class="text-4xl font-display text-primary uppercase">${de.formatCurrency(n.totalGasto)}</p>`})}
                    ${U.createCard({title:"Total de Pedidos",content:`<p class="text-4xl font-display text-primary uppercase">${n.totalPedidos}</p>`})}
                    ${U.createCard({title:"% Curva S (Comprometido vs Limite)",content:`<p class="text-4xl font-display text-${n.curvaPercent>100?"alert":"primary"} uppercase">${(n.curvaPercent||0).toFixed(1)}%</p><p class="text-sm heading-muted mt-1">Limite: ${de.formatCurrency(n.limiteReal||0)} • Comprometido: ${de.formatCurrency(n.comprometido||0)}</p>`})}
                    ...
                    ${U.createCard({title:"Economia (Limite - Comprometido)",content:`<p class="text-4xl font-display text-primary uppercase">${de.formatCurrency(n.economia||0)}</p>`})}
                </div>
...
`):n}function aC(n,t){const{element:e,datasetIndex:s,index:i}=t,r=n.getDatasetMeta(s).controller,{label:o,value:a}=r.getLabelAndValue(i);return{chart:n,label:o,parsed:r.getParsed(i),raw:n.data.datasets[s].data[i],formattedValue:a,dataset:r.getDataset(),dataIndex:i,datasetIndex:s,element:e}}function Lp(n,t){const e=n.chart.ctx,{body:s,footer:i,title:r}=n,{boxWidth:o,boxHeight:a}=t,l=Vt(t.bodyFont),u=Vt(t.titleFont),h=Vt(t.footerFont),d=r.length,p=i.length,m=s.length,_=se(t.padding);let v=_.height,y=0,A=s.reduce((P,O)=>P+O.before.length+O.lines.length+O.after.length,0);if(A+=n.beforeBody.length+n.afterBody.length,d&&(v+=d*u.lineHeight+(d-1)*t.titleSpacing+t.titleMarginBottom),A){const P=t.displayColors?Math.max(a,l.lineHeight):l.lineHeight;v+=m*P+(A-m)*l.lineHeight+(A-1)*t.bodySpacing}p&&(v+=t.footerMarginTop+p*h.lineHeight+(p-1)*t.footerSpacing);let R=0;const D=function(P){y=Math.max(y,e.measureText(P).width+R)};return e.save(),e.font=u.string,it(n.title,D),e.font=l.string,it(n.beforeBody.concat(n.afterBody),D),R=t.displayColors?o+2+t.boxPadding:0,it(s,P=>{it(P.before,D),it(P.lines,D),it(P.after,D)}),R=0,e.font=h.string,it(n.footer,D),e.restore(),y+=_.width,{width:y,height:v}}function lC(n,t){const{y:e,height:s}=t;return e<s/2?"top":e>n.height-s/2?"bottom":"center"}function cC(n,t,e,s){const{x:i,width:r}=s,o=e.caretSize+e.caretPadding;if(n==="left"&&i+r+o>t.width||n==="right"&&i-r-o<0)return!0}function uC(n,t,e,s){const{x:i,width:r}=e,{width:o,chartArea:{left:a,right:l}}=n;let u="center";return s==="center"?u=i<=(a+l)/2?"left":"right":i<=r/2?u="left":i>=o-r/2&&(u="right"),cC(u,n,t,e)&&(u="center"),u}function Np(n,t,e){const s=e.yAlign||t.yAlign||lC(n,e);return{xAlign:e.xAlign||t.xAlign||uC(n,t,e,s),yAlign:s}}function hC(n,t){let{x:e,width:s}=n;return t==="right"?e-=s:t==="center"&&(e-=s/2),e}function dC(n,t,e){let{y:s,height:i}=n;return t==="top"?s+=e:t==="bottom"?s-=i+e:s-=i/2,s}function Vp(n,t,e,s){const{caretSize:i,caretPadding:r,cornerRadius:o}=n,{xAlign:a,yAlign:l}=e,u=i+r,{topLeft:h,topRight:d,bottomLeft:p,bottomRight:m}=as(o);let _=hC(t,a);const v=dC(t,l,u);return l==="center"?a==="left"?_+=u:a==="right"&&(_-=u):a==="left"?_-=Math.max(h,p)+i:a==="right"&&(_+=Math.max(d,m)+i),{x:Ut(_,0,s.width-t.width),y:Ut(v,0,s.height-t.height)}}function yo(n,t,e){const s=se(e.padding);return t==="center"?n.x+n.width/2:t==="right"?n.x+n.width-s.right:n.x+s.left}function Fp(n){return Oe([],Je(n))}function fC(n,t,e){return Wn(n,{tooltip:t,tooltipItems:e,type:"tooltip"})}function Bp(n,t){const e=t&&t.dataset&&t.dataset.tooltip&&t.dataset.tooltip.callbacks;return e?n.override(e):n}const Oy={beforeTitle:Xe,title(n){if(n.length>0){const t=n[0],e=t.chart.data.labels,s=e?e.length:0;if(this&&this.options&&this.options.mode==="dataset")return t.dataset.label||"";if(t.label)return t.label;if(s>0&&t.dataIndex<s)return e[t.dataIndex]}return""},afterTitle:Xe,beforeBody:Xe,beforeLabel:Xe,label(n){if(this&&this.options&&this.options.mode==="dataset")return n.label+": "+n.formattedValue||n.formattedValue;let t=n.dataset.label||"";t&&(t+=": ");const e=n.formattedValue;return Y(e)||(t+=e),t},labelColor(n){const e=n.chart.getDatasetMeta(n.datasetIndex).controller.getStyle(n.dataIndex);return{borderColor:e.borderColor,backgroundColor:e.backgroundColor,borderWidth:e.borderWidth,borderDash:e.borderDash,borderDashOffset:e.borderDashOffset,borderRadius:0}},labelTextColor(){return this.options.bodyColor},labelPointStyle(n){const e=n.chart.getDatasetMeta(n.datasetIndex).controller.getStyle(n.dataIndex);return{pointStyle:e.pointStyle,rotation:e.rotation}},afterLabel:Xe,afterBody:Xe,beforeFooter:Xe,footer:Xe,afterFooter:Xe};function ce(n,t,e,s){const i=n[t].call(e,s);return typeof i>"u"?Oy[t].call(e,s):i}class Mc extends De{constructor(t){super(),this.opacity=0,this._active=[],this._eventPosition=void 0,this._size=void 0,this._cachedAnimations=void 0,this._tooltipItems=[],this.$animations=void 0,this.$context=void 0,this.chart=t.chart,this.options=t.options,this.dataPoints=void 0,this.title=void 0,this.beforeBody=void 0,this.body=void 0,this.afterBody=void 0,this.footer=void 0,this.xAlign=void 0,this.yAlign=void 0,this.x=void 0,this.y=void 0,this.height=void 0,this.width=void 0,this.caretX=void 0,this.caretY=void 0,this.labelColors=void 0,this.labelPointStyles=void 0,this.labelTextColors=void 0}initialize(t){this.options=t,this._cachedAnimations=void 0,this.$context=void 0}_resolveAnimations(){const t=this._cachedAnimations;if(t)return t;const e=this.chart,s=this.options.setContext(this.getContext()),i=s.enabled&&e.options.animation&&s.animations,r=new dy(this.chart,i);return i._cacheable&&(this._cachedAnimations=Object.freeze(r)),r}getContext(){return this.$context||(this.$context=fC(this.chart.getContext(),this,this._tooltipItems))}getTitle(t,e){const{callbacks:s}=e,i=ce(s,"beforeTitle",this,t),r=ce(s,"title",this,t),o=ce(s,"afterTitle",this,t);let a=[];return a=Oe(a,Je(i)),a=Oe(a,Je(r)),a=Oe(a,Je(o)),a}getBeforeBody(t,e){return Fp(ce(e.callbacks,"beforeBody",this,t))}getBody(t,e){const{callbacks:s}=e,i=[];return it(t,r=>{const o={before:[],lines:[],after:[]},a=Bp(s,r);Oe(o.before,Je(ce(a,"beforeLabel",this,r))),Oe(o.lines,ce(a,"label",this,r)),Oe(o.after,Je(ce(a,"afterLabel",this,r))),i.push(o)}),i}getAfterBody(t,e){return Fp(ce(e.callbacks,"afterBody",this,t))}getFooter(t,e){const{callbacks:s}=e,i=ce(s,"beforeFooter",this,t),r=ce(s,"footer",this,t),o=ce(s,"afterFooter",this,t);let a=[];return a=Oe(a,Je(i)),a=Oe(a,Je(r)),a=Oe(a,Je(o)),a}_createItems(t){const e=this._active,s=this.chart.data,i=[],r=[],o=[];let a=[],l,u;for(l=0,u=e.length;l<u;++l)a.push(aC(this.chart,e[l]));return t.filter&&(a=a.filter((h,d,p)=>t.filter(h,d,p,s))),t.itemSort&&(a=a.sort((h,d)=>t.itemSort(h,d,s))),it(a,h=>{const d=Bp(t.callbacks,h);i.push(ce(d,"labelColor",this,h)),r.push(ce(d,"labelPointStyle",this,h)),o.push(ce(d,"labelTextColor",this,h))}),this.labelColors=i,this.labelPointStyles=r,this.labelTextColors=o,this.dataPoints=a,a}update(t,e){const s=this.options.setContext(this.getContext()),i=this._active;let r,o=[];if(!i.length)this.opacity!==0&&(r={opacity:0});else{const a=Ui[s.position].call(this,i,this._eventPosition);o=this._createItems(s),this.title=this.getTitle(o,s),this.beforeBody=this.getBeforeBody(o,s),this.body=this.getBody(o,s),this.afterBody=this.getAfterBody(o,s),this.footer=this.getFooter(o,s);const l=this._size=Lp(this,s),u=Object.assign({},a,l),h=Np(this.chart,s,u),d=Vp(s,u,h,this.chart);this.xAlign=h.xAlign,this.yAlign=h.yAlign,r={opacity:1,x:d.x,y:d.y,width:l.width,height:l.height,caretX:a.x,caretY:a.y}}this._tooltipItems=o,this.$context=void 0,r&&this._resolveAnimations().update(this,r),t&&s.external&&s.external.call(this,{chart:this.chart,tooltip:this,replay:e})}drawCaret(t,e,s,i){const r=this.getCaretPosition(t,s,i);e.lineTo(r.x1,r.y1),e.lineTo(r.x2,r.y2),e.lineTo(r.x3,r.y3)}getCaretPosition(t,e,s){const{xAlign:i,yAlign:r}=this,{caretSize:o,cornerRadius:a}=s,{topLeft:l,topRight:u,bottomLeft:h,bottomRight:d}=as(a),{x:p,y:m}=t,{width:_,height:v}=e;let y,A,R,D,P,O;return r==="center"?(P=m+v/2,i==="left"?(y=p,A=y-o,D=P+o,O=P-o):(y=p+_,A=y+o,D=P-o,O=P+o),R=y):(i==="left"?A=p+Math.max(l,h)+o:i==="right"?A=p+_-Math.max(u,d)-o:A=this.caretX,r==="top"?(D=m,P=D-o,y=A-o,R=A+o):(D=m+v,P=D+o,y=A+o,R=A-o),O=D),{x1:y,x2:A,x3:R,y1:D,y2:P,y3:O}}drawTitle(t,e,s){const i=this.title,r=i.length;let o,a,l;if(r){const u=js(s.rtl,this.x,this.width);for(t.x=yo(this,s.titleAlign,s),e.textAlign=u.textAlign(s.titleAlign),e.textBaseline="middle",o=Vt(s.titleFont),a=s.titleSpacing,e.fillStyle=s.titleColor,e.font=o.string,l=0;l<r;++l)e.fillText(i[l],u.x(t.x),t.y+o.lineHeight/2),t.y+=o.lineHeight+a,l+1===r&&(t.y+=s.titleMarginBottom-a)}}_drawColorBox(t,e,s,i,r){const o=this.labelColors[s],a=this.labelPointStyles[s],{boxHeight:l,boxWidth:u}=r,h=Vt(r.bodyFont),d=yo(this,"left",r),p=i.x(d),m=l<h.lineHeight?(h.lineHeight-l)/2:0,_=e.y+m;if(r.usePointStyle){const v={radius:Math.min(u,l)/2,pointStyle:a.pointStyle,rotation:a.rotation,borderWidth:1},y=i.leftForLtr(p,u)+u/2,A=_+l/2;t.strokeStyle=r.multiKeyBackground,t.fillStyle=r.multiKeyBackground,Sc(t,v,y,A),t.strokeStyle=o.borderColor,t.fillStyle=o.backgroundColor,Sc(t,v,y,A)}else{t.lineWidth=Q(o.borderWidth)?Math.max(...Object.values(o.borderWidth)):o.borderWidth||1,t.strokeStyle=o.borderColor,t.setLineDash(o.borderDash||[]),t.lineDashOffset=o.borderDashOffset||0;const v=i.leftForLtr(p,u),y=i.leftForLtr(i.xPlus(p,1),u-2),A=as(o.borderRadius);Object.values(A).some(R=>R!==0)?(t.beginPath(),t.fillStyle=r.multiKeyBackground,fr(t,{x:v,y:_,w:u,h:l,radius:A}),t.fill(),t.stroke(),t.fillStyle=o.backgroundColor,t.beginPath(),fr(t,{x:y,y:_+1,w:u-2,h:l-2,radius:A}),t.fill()):(t.fillStyle=r.multiKeyBackground,t.fillRect(v,_,u,l),t.strokeRect(v,_,u,l),t.fillStyle=o.backgroundColor,t.fillRect(y,_+1,u-2,l-2))}t.fillStyle=this.labelTextColors[s]}drawBody(t,e,s){const{body:i}=this,{bodySpacing:r,bodyAlign:o,displayColors:a,boxHeight:l,boxWidth:u,boxPadding:h}=s,d=Vt(s.bodyFont);let p=d.lineHeight,m=0;const _=js(s.rtl,this.x,this.width),v=function(b){e.fillText(b,_.x(t.x+m),t.y+p/2),t.y+=p+r},y=_.textAlign(o);let A,R,D,P,O,L,E;for(e.textAlign=o,e.textBaseline="middle",e.font=d.string,t.x=yo(this,y,s),e.fillStyle=s.bodyColor,it(this.beforeBody,v),m=a&&y!=="right"?o==="center"?u/2+h:u+2+h:0,P=0,L=i.length;P<L;++P){for(A=i[P],R=this.labelTextColors[P],e.fillStyle=R,it(A.before,v),D=A.lines,a&&D.length&&(this._drawColorBox(e,t,P,_,s),p=Math.max(d.lineHeight,l)),O=0,E=D.length;O<E;++O)v(D[O]),p=d.lineHeight;it(A.after,v)}m=0,p=d.lineHeight,it(this.afterBody,v),t.y-=r}drawFooter(t,e,s){const i=this.footer,r=i.length;let o,a;if(r){const l=js(s.rtl,this.x,this.width);for(t.x=yo(this,s.footerAlign,s),t.y+=s.footerMarginTop,e.textAlign=l.textAlign(s.footerAlign),e.textBaseline="middle",o=Vt(s.footerFont),e.fillStyle=s.footerColor,e.font=o.string,a=0;a<r;++a)e.fillText(i[a],l.x(t.x),t.y+o.lineHeight/2),t.y+=o.lineHeight+s.footerSpacing}}drawBackground(t,e,s,i){const{xAlign:r,yAlign:o}=this,{x:a,y:l}=t,{width:u,height:h}=s,{topLeft:d,topRight:p,bottomLeft:m,bottomRight:_}=as(i.cornerRadius);e.fillStyle=i.backgroundColor,e.strokeStyle=i.borderColor,e.lineWidth=i.borderWidth,e.beginPath(),e.moveTo(a+d,l),o==="top"&&this.drawCaret(t,e,s,i),e.lineTo(a+u-p,l),e.quadraticCurveTo(a+u,l,a+u,l+p),o==="center"&&r==="right"&&this.drawCaret(t,e,s,i),e.lineTo(a+u,l+h-_),e.quadraticCurveTo(a+u,l+h,a+u-_,l+h),o==="bottom"&&this.drawCaret(t,e,s,i),e.lineTo(a+m,l+h),e.quadraticCurveTo(a,l+h,a,l+h-m),o==="center"&&r==="left"&&this.drawCaret(t,e,s,i),e.lineTo(a,l+d),e.quadraticCurveTo(a,l,a+d,l),e.closePath(),e.fill(),i.borderWidth>0&&e.stroke()}_updateAnimationTarget(t){const e=this.chart,s=this.$animations,i=s&&s.x,r=s&&s.y;if(i||r){const o=Ui[t.position].call(this,this._active,this._eventPosition);if(!o)return;const a=this._size=Lp(this,t),l=Object.assign({},o,this._size),u=Np(e,t,l),h=Vp(t,l,u,e);(i._to!==h.x||r._to!==h.y)&&(this.xAlign=u.xAlign,this.yAlign=u.yAlign,this.width=a.width,this.height=a.height,this.caretX=o.x,this.caretY=o.y,this._resolveAnimations().update(this,h))}}_willRender(){return!!this.opacity}draw(t){const e=this.options.setContext(this.getContext());let s=this.opacity;if(!s)return;this._updateAnimationTarget(e);const i={width:this.width,height:this.height},r={x:this.x,y:this.y};s=Math.abs(s)<.001?0:s;const o=se(e.padding),a=this.title.length||this.beforeBody.length||this.body.length||this.afterBody.length||this.footer.length;e.enabled&&a&&(t.save(),t.globalAlpha=s,this.drawBackground(r,t,i,e),oy(t,e.textDirection),r.y+=o.top,this.drawTitle(r,t,e),this.drawBody(r,t,e),this.drawFooter(r,t,e),ay(t,e.textDirection),t.restore())}getActiveElements(){return this._active||[]}setActiveElements(t,e){const s=this._active,i=t.map(({datasetIndex:a,index:l})=>{const u=this.chart.getDatasetMeta(a);if(!u)throw new Error("Cannot find a dataset at index "+a);return{datasetIndex:a,element:u.data[l],index:l}}),r=!la(s,i),o=this._positionChanged(i,e);(r||o)&&(this._active=i,this._eventPosition=e,this._ignoreReplayEvents=!0,this.update(!0))}handleEvent(t,e,s=!0){if(e&&this._ignoreReplayEvents)return!1;this._ignoreReplayEvents=!1;const i=this.options,r=this._active||[],o=this._getActiveElements(t,r,e,s),a=this._positionChanged(o,t),l=e||!la(o,r)||a;return l&&(this._active=o,(i.enabled||i.external)&&(this._eventPosition={x:t.x,y:t.y},this.update(!0,e))),l}_getActiveElements(t,e,s,i){const r=this.options;if(t.type==="mouseout")return[];if(!i)return e.filter(a=>this.chart.data.datasets[a.datasetIndex]&&this.chart.getDatasetMeta(a.datasetIndex).controller.getParsed(a.index)!==void 0);const o=this.chart.getElementsAtEventForMode(t,r.mode,r,s);return r.reverse&&o.reverse(),o}_positionChanged(t,e){const{caretX:s,caretY:i,options:r}=this,o=Ui[r.position].call(this,t,e);return o!==!1&&(s!==o.x||i!==o.y)}}B(Mc,"positioners",Ui);var pC={id:"tooltip",_element:Mc,positioners:Ui,afterInit(n,t,e){e&&(n.tooltip=new Mc({chart:n,options:e}))},beforeUpdate(n,t,e){n.tooltip&&n.tooltip.initialize(e)},reset(n,t,e){n.tooltip&&n.tooltip.initialize(e)},afterDraw(n){const t=n.tooltip;if(t&&t._willRender()){const e={tooltip:t};if(n.notifyPlugins("beforeTooltipDraw",{...e,cancelable:!0})===!1)return;t.draw(n.ctx),n.notifyPlugins("afterTooltipDraw",e)}},afterEvent(n,t){if(n.tooltip){const e=t.replay;n.tooltip.handleEvent(t.event,e,t.inChartArea)&&(t.changed=!0)}},defaults:{enabled:!0,external:null,position:"average",backgroundColor:"rgba(0,0,0,0.8)",titleColor:"#fff",titleFont:{weight:"bold"},titleSpacing:2,titleMarginBottom:6,titleAlign:"left",bodyColor:"#fff",bodySpacing:2,bodyFont:{},bodyAlign:"left",footerColor:"#fff",footerSpacing:2,footerMarginTop:6,footerFont:{weight:"bold"},footerAlign:"left",padding:6,caretPadding:2,caretSize:5,cornerRadius:6,boxHeight:(n,t)=>t.bodyFont.size,boxWidth:(n,t)=>t.bodyFont.size,multiKeyBackground:"#fff",displayColors:!0,boxPadding:0,borderColor:"rgba(0,0,0,0)",borderWidth:0,animation:{duration:400,easing:"easeOutQuart"},animations:{numbers:{type:"number",properties:["x","y","width","height","caretX","caretY"]},opacity:{easing:"linear",duration:200}},callbacks:Oy},defaultRoutes:{bodyFont:"font",footerFont:"font",titleFont:"font"},descriptors:{_scriptable:n=>n!=="filter"&&n!=="itemSort"&&n!=="external",_indexable:!1,callbacks:{_scriptable:!1,_indexable:!1},animation:{_fallback:!1},animations:{_fallback:"animation"}},additionalOptionScopes:["interaction"]},gC=Object.freeze({__proto__:null,Colors:SP,Decimation:CP,Filler:QP,Legend:sC,SubTitle:oC,Title:rC,Tooltip:pC});const mC=(n,t,e,s)=>(typeof t=="string"?(e=n.push(t)-1,s.unshift({index:e,label:t})):isNaN(t)&&(e=null),e);function _C(n,t,e,s){const i=n.indexOf(t);if(i===-1)return mC(n,t,e,s);const r=n.lastIndexOf(t);return i!==r?e:i}const yC=(n,t)=>n===null?null:Ut(Math.round(n),0,t);function Up(n){const t=this.getLabels();return n>=0&&n<t.length?t[n]:n}class Lc extends xs{constructor(t){super(t),this._startValue=void 0,this._valueRange=0,this._addedLabels=[]}init(t){const e=this._addedLabels;if(e.length){const s=this.getLabels();for(const{index:i,label:r}of e)s[i]===r&&s.splice(i,1);this._addedLabels=[]}super.init(t)}parse(t,e){if(Y(t))return null;const s=this.getLabels();return e=isFinite(e)&&s[e]===t?e:_C(s,t,G(e,t),this._addedLabels),yC(e,s.length-1)}determineDataLimits(){const{minDefined:t,maxDefined:e}=this.getUserBounds();let{min:s,max:i}=this.getMinMax(!0);this.options.bounds==="ticks"&&(t||(s=0),e||(i=this.getLabels().length-1)),this.min=s,this.max=i}buildTicks(){const t=this.min,e=this.max,s=this.options.offset,i=[];let r=this.getLabels();r=t===0&&e===r.length-1?r:r.slice(t,e+1),this._valueRange=Math.max(r.length-(s?0:1),1),this._startValue=this.min-(s?.5:0);for(let o=t;o<=e;o++)i.push({value:o});return i}getLabelForValue(t){return Up.call(this,t)}configure(){super.configure(),this.isHorizontal()||(this._reversePixels=!this._reversePixels)}getPixelForValue(t){return typeof t!="number"&&(t=this.parse(t)),t===null?NaN:this.getPixelForDecimal((t-this._startValue)/this._valueRange)}getPixelForTick(t){const e=this.ticks;return t<0||t>e.length-1?null:this.getPixelForValue(e[t].value)}getValueForPixel(t){return Math.round(this._startValue+this.getDecimalForPixel(t)*this._valueRange)}getBasePixel(){return this.bottom}}B(Lc,"id","category"),B(Lc,"defaults",{ticks:{callback:Up}});function vC(n,t){const e=[],{bounds:i,step:r,min:o,max:a,precision:l,count:u,maxTicks:h,maxDigits:d,includeBounds:p}=n,m=r||1,_=h-1,{min:v,max:y}=t,A=!Y(o),R=!Y(a),D=!Y(u),P=(y-v)/(d+1);let O=Lf((y-v)/_/m)*m,L,E,b,x;if(O<1e-14&&!A&&!R)return[{value:v},{value:y}];x=Math.ceil(y/O)-Math.floor(v/O),x>_&&(O=Lf(x*O/_/m)*m),Y(l)||(L=Math.pow(10,l),O=Math.ceil(O*L)/L),i==="ticks"?(E=Math.floor(v/O)*O,b=Math.ceil(y/O)*O):(E=v,b=y),A&&R&&r&&hS((a-o)/r,O/1e3)?(x=Math.round(Math.min((a-o)/O,h)),O=(a-o)/x,E=o,b=a):D?(E=A?o:E,b=R?a:b,x=u-1,O=(b-E)/x):(x=(b-E)/O,Yi(x,Math.round(x),O/1e3)?x=Math.round(x):x=Math.ceil(x));const I=Math.max(Nf(O),Nf(E));L=Math.pow(10,Y(l)?I:l),E=Math.round(E*L)/L,b=Math.round(b*L)/L;let S=0;for(A&&(p&&E!==o?(e.push({value:o}),E<o&&S++,Yi(Math.round((E+S*O)*L)/L,o,$p(o,P,n))&&S++):E<o&&S++);S<x;++S){const k=Math.round((E+S*O)*L)/L;if(R&&k>a)break;e.push({value:k})}return R&&p&&b!==a?e.length&&Yi(e[e.length-1].value,a,$p(a,P,n))?e[e.length-1].value=a:e.push({value:a}):(!R||b===a)&&e.push({value:b}),e}function $p(n,t,{horizontal:e,minRotation:s}){const i=Ae(s),r=(e?Math.sin(i):Math.cos(i))||.001,o=.75*t*(""+n).length;return Math.min(t/r,o)}class ga extends xs{constructor(t){super(t),this.start=void 0,this.end=void 0,this._startValue=void 0,this._endValue=void 0,this._valueRange=0}parse(t,e){return Y(t)||(typeof t=="number"||t instanceof Number)&&!isFinite(+t)?null:+t}handleTickRangeOptions(){const{beginAtZero:t}=this.options,{minDefined:e,maxDefined:s}=this.getUserBounds();let{min:i,max:r}=this;const o=l=>i=e?i:l,a=l=>r=s?r:l;if(t){const l=ze(i),u=ze(r);l<0&&u<0?a(0):l>0&&u>0&&o(0)}if(i===r){let l=r===0?1:Math.abs(r*.05);a(r+l),t||o(i-l)}this.min=i,this.max=r}getTickLimit(){const t=this.options.ticks;let{maxTicksLimit:e,stepSize:s}=t,i;return s?(i=Math.ceil(this.max/s)-Math.floor(this.min/s)+1,i>1e3&&(console.warn(`scales.${this.id}.ticks.stepSize: ${s} would result generating up to ${i} ticks. Limiting to 1000.`),i=1e3)):(i=this.computeTickLimit(),e=e||11),e&&(i=Math.min(e,i)),i}computeTickLimit(){return Number.POSITIVE_INFINITY}buildTicks(){const t=this.options,e=t.ticks;let s=this.getTickLimit();s=Math.max(2,s);const i={maxTicks:s,bounds:t.bounds,min:t.min,max:t.max,precision:e.precision,step:e.stepSize,count:e.count,maxDigits:this._maxDigits(),horizontal:this.isHorizontal(),minRotation:e.minRotation||0,includeBounds:e.includeBounds!==!1},r=this._range||this,o=vC(i,r);return t.bounds==="ticks"&&j_(o,this,"value"),t.reverse?(o.reverse(),this.start=this.max,this.end=this.min):(this.start=this.min,this.end=this.max),o}configure(){const t=this.ticks;let e=this.min,s=this.max;if(super.configure(),this.options.offset&&t.length){const i=(s-e)/Math.max(t.length-1,1)/2;e-=i,s+=i}this._startValue=e,this._endValue=s,this._valueRange=s-e}getLabelForValue(t){return Dr(t,this.chart.options.locale,this.options.ticks.format)}}class Nc extends ga{determineDataLimits(){const{min:t,max:e}=this.getMinMax(!0);this.min=It(t)?t:0,this.max=It(e)?e:1,this.handleTickRangeOptions()}computeTickLimit(){const t=this.isHorizontal(),e=t?this.width:this.height,s=Ae(this.options.ticks.minRotation),i=(t?Math.sin(s):Math.cos(s))||.001,r=this._resolveTickFontOptions(0);return Math.ceil(e/Math.min(40,r.lineHeight/i))}getPixelForValue(t){return t===null?NaN:this.getPixelForDecimal((t-this._startValue)/this._valueRange)}getValueForPixel(t){return this._startValue+this.getDecimalForPixel(t)*this._valueRange}}B(Nc,"id","linear"),B(Nc,"defaults",{ticks:{callback:$a.formatters.numeric}});const gr=n=>Math.floor(Sn(n)),Zn=(n,t)=>Math.pow(10,gr(n)+t);function zp(n){return n/Math.pow(10,gr(n))===1}function jp(n,t,e){const s=Math.pow(10,e),i=Math.floor(n/s);return Math.ceil(t/s)-i}function bC(n,t){const e=t-n;let s=gr(e);for(;jp(n,t,s)>10;)s++;for(;jp(n,t,s)<10;)s--;return Math.min(s,gr(n))}function wC(n,{min:t,max:e}){t=_e(n.min,t);const s=[],i=gr(t);let r=bC(t,e),o=r<0?Math.pow(10,Math.abs(r)):1;const a=Math.pow(10,r),l=i>r?Math.pow(10,i):0,u=Math.round((t-l)*o)/o,h=Math.floor((t-l)/a/10)*a*10;let d=Math.floor((u-h)/Math.pow(10,r)),p=_e(n.min,Math.round((l+h+d*Math.pow(10,r))*o)/o);for(;p<e;)s.push({value:p,major:zp(p),significand:d}),d>=10?d=d<15?15:20:d++,d>=20&&(r++,d=2,o=r>=0?1:o),p=Math.round((l+h+d*Math.pow(10,r))*o)/o;const m=_e(n.max,p);return s.push({value:m,major:zp(m),significand:d}),s}class Vc extends xs{constructor(t){super(t),this.start=void 0,this.end=void 0,this._startValue=void 0,this._valueRange=0}parse(t,e){const s=ga.prototype.parse.apply(this,[t,e]);if(s===0){this._zero=!0;return}return It(s)&&s>0?s:null}determineDataLimits(){const{min:t,max:e}=this.getMinMax(!0);this.min=It(t)?Math.max(0,t):null,this.max=It(e)?Math.max(0,e):null,this.options.beginAtZero&&(this._zero=!0),this._zero&&this.min!==this._suggestedMin&&!It(this._userMin)&&(this.min=t===Zn(this.min,0)?Zn(this.min,-1):Zn(this.min,0)),this.handleTickRangeOptions()}handleTickRangeOptions(){const{minDefined:t,maxDefined:e}=this.getUserBounds();let s=this.min,i=this.max;const r=a=>s=t?s:a,o=a=>i=e?i:a;s===i&&(s<=0?(r(1),o(10)):(r(Zn(s,-1)),o(Zn(i,1)))),s<=0&&r(Zn(i,-1)),i<=0&&o(Zn(s,1)),this.min=s,this.max=i}buildTicks(){const t=this.options,e={min:this._userMin,max:this._userMax},s=wC(e,this);return t.bounds==="ticks"&&j_(s,this,"value"),t.reverse?(s.reverse(),this.start=this.max,this.end=this.min):(this.start=this.min,this.end=this.max),s}getLabelForValue(t){return t===void 0?"0":Dr(t,this.chart.options.locale,this.options.ticks.format)}configure(){const t=this.min;super.configure(),this._startValue=Sn(t),this._valueRange=Sn(this.max)-Sn(t)}getPixelForValue(t){return(t===void 0||t===0)&&(t=this.min),t===null||isNaN(t)?NaN:this.getPixelForDecimal(t===this.min?0:(Sn(t)-this._startValue)/this._valueRange)}getValueForPixel(t){const e=this.getDecimalForPixel(t);return Math.pow(10,this._startValue+e*this._valueRange)}}B(Vc,"id","logarithmic"),B(Vc,"defaults",{ticks:{callback:$a.formatters.logarithmic,major:{enabled:!0}}});function Fc(n){const t=n.ticks;if(t.display&&n.display){const e=se(t.backdropPadding);return G(t.font&&t.font.size,vt.font.size)+e.height}return 0}function xC(n,t,e){return e=yt(e)?e:[e],{w:RS(n,t.string,e),h:e.length*t.lineHeight}}function Hp(n,t,e,s,i){return n===s||n===i?{start:t-e/2,end:t+e/2}:n<s||n>i?{start:t-e,end:t}:{start:t,end:t+e}}function EC(n){const t={l:n.left+n._padding.left,r:n.right-n._padding.right,t:n.top+n._padding.top,b:n.bottom-n._padding.bottom},e=Object.assign({},t),s=[],i=[],r=n._pointLabels.length,o=n.options.pointLabels,a=o.centerPointLabels?st/r:0;for(let l=0;l<r;l++){const u=o.setContext(n.getPointLabelContext(l));i[l]=u.padding;const h=n.getPointPosition(l,n.drawingArea+i[l],a),d=Vt(u.font),p=xC(n.ctx,d,n._pointLabels[l]);s[l]=p;const m=Zt(n.getIndexAngle(l)+a),_=Math.round(qu(m)),v=Hp(_,h.x,p.w,0,180),y=Hp(_,h.y,p.h,90,270);TC(e,t,m,v,y)}n.setCenterPoint(t.l-e.l,e.r-t.r,t.t-e.t,e.b-t.b),n._pointLabelItems=SC(n,s,i)}function TC(n,t,e,s,i){const r=Math.abs(Math.sin(e)),o=Math.abs(Math.cos(e));let a=0,l=0;s.start<t.l?(a=(t.l-s.start)/r,n.l=Math.min(n.l,t.l-a)):s.end>t.r&&(a=(s.end-t.r)/r,n.r=Math.max(n.r,t.r+a)),i.start<t.t?(l=(t.t-i.start)/o,n.t=Math.min(n.t,t.t-l)):i.end>t.b&&(l=(i.end-t.b)/o,n.b=Math.max(n.b,t.b+l))}function IC(n,t,e){const s=n.drawingArea,{extra:i,additionalAngle:r,padding:o,size:a}=e,l=n.getPointPosition(t,s+i+o,r),u=Math.round(qu(Zt(l.angle+Rt))),h=PC(l.y,a.h,u),d=RC(u),p=kC(l.x,a.w,d);return{visible:!0,x:l.x,y:h,textAlign:d,left:p,top:h,right:p+a.w,bottom:h+a.h}}function AC(n,t){if(!t)return!0;const{left:e,top:s,right:i,bottom:r}=n;return!(an({x:e,y:s},t)||an({x:e,y:r},t)||an({x:i,y:s},t)||an({x:i,y:r},t))}function SC(n,t,e){const s=[],i=n._pointLabels.length,r=n.options,{centerPointLabels:o,display:a}=r.pointLabels,l={extra:Fc(r)/2,additionalAngle:o?st/i:0};let u;for(let h=0;h<i;h++){l.padding=e[h],l.size=t[h];const d=IC(n,h,l);s.push(d),a==="auto"&&(d.visible=AC(d,u),d.visible&&(u=d))}return s}function RC(n){return n===0||n===180?"center":n<180?"left":"right"}function kC(n,t,e){return e==="right"?n-=t:e==="center"&&(n-=t/2),n}function PC(n,t,e){return e===90||e===270?n-=t/2:(e>270||e<90)&&(n-=t),n}function CC(n,t,e){const{left:s,top:i,right:r,bottom:o}=e,{backdropColor:a}=t;if(!Y(a)){const l=as(t.borderRadius),u=se(t.backdropPadding);n.fillStyle=a;const h=s-u.left,d=i-u.top,p=r-s+u.width,m=o-i+u.height;Object.values(l).some(_=>_!==0)?(n.beginPath(),fr(n,{x:h,y:d,w:p,h:m,radius:l}),n.fill()):n.fillRect(h,d,p,m)}}function DC(n,t){const{ctx:e,options:{pointLabels:s}}=n;for(let i=t-1;i>=0;i--){const r=n._pointLabelItems[i];if(!r.visible)continue;const o=s.setContext(n.getPointLabelContext(i));CC(e,o,r);const a=Vt(o.font),{x:l,y:u,textAlign:h}=r;ms(e,n._pointLabels[i],l,u+a.lineHeight/2,a,{color:o.color,textAlign:h,textBaseline:"middle"})}}function My(n,t,e,s){const{ctx:i}=n;if(e)i.arc(n.xCenter,n.yCenter,t,0,gt);else{let r=n.getPointPosition(0,t);i.moveTo(r.x,r.y);for(let o=1;o<s;o++)r=n.getPointPosition(o,t),i.lineTo(r.x,r.y)}}function OC(n,t,e,s,i){const r=n.ctx,o=t.circular,{color:a,lineWidth:l}=t;!o&&!s||!a||!l||e<0||(r.save(),r.strokeStyle=a,r.lineWidth=l,r.setLineDash(i.dash||[]),r.lineDashOffset=i.dashOffset,r.beginPath(),My(n,e,o,s),r.closePath(),r.stroke(),r.restore())}function MC(n,t,e){return Wn(n,{label:e,index:t,type:"pointLabel"})}class $i extends ga{constructor(t){super(t),this.xCenter=void 0,this.yCenter=void 0,this.drawingArea=void 0,this._pointLabels=[],this._pointLabelItems=[]}setDimensions(){const t=this._padding=se(Fc(this.options)/2),e=this.width=this.maxWidth-t.width,s=this.height=this.maxHeight-t.height;this.xCenter=Math.floor(this.left+e/2+t.left),this.yCenter=Math.floor(this.top+s/2+t.top),this.drawingArea=Math.floor(Math.min(e,s)/2)}determineDataLimits(){const{min:t,max:e}=this.getMinMax(!1);this.min=It(t)&&!isNaN(t)?t:0,this.max=It(e)&&!isNaN(e)?e:0,this.handleTickRangeOptions()}computeTickLimit(){return Math.ceil(this.drawingArea/Fc(this.options))}generateTickLabels(t){ga.prototype.generateTickLabels.call(this,t),this._pointLabels=this.getLabels().map((e,s)=>{const i=ht(this.options.pointLabels.callback,[e,s],this);return i||i===0?i:""}).filter((e,s)=>this.chart.getDataVisibility(s))}fit(){const t=this.options;t.display&&t.pointLabels.display?EC(this):this.setCenterPoint(0,0,0,0)}setCenterPoint(t,e,s,i){this.xCenter+=Math.floor((t-e)/2),this.yCenter+=Math.floor((s-i)/2),this.drawingArea-=Math.min(this.drawingArea/2,Math.max(t,e,s,i))}getIndexAngle(t){const e=gt/(this._pointLabels.length||1),s=this.options.startAngle||0;return Zt(t*e+Ae(s))}getDistanceFromCenterForValue(t){if(Y(t))return NaN;const e=this.drawingArea/(this.max-this.min);return this.options.reverse?(this.max-t)*e:(t-this.min)*e}getValueForDistanceFromCenter(t){if(Y(t))return NaN;const e=t/(this.drawingArea/(this.max-this.min));return this.options.reverse?this.max-e:this.min+e}getPointLabelContext(t){const e=this._pointLabels||[];if(t>=0&&t<e.length){const s=e[t];return MC(this.getContext(),t,s)}}getPointPosition(t,e,s=0){const i=this.getIndexAngle(t)-Rt+s;return{x:Math.cos(i)*e+this.xCenter,y:Math.sin(i)*e+this.yCenter,angle:i}}getPointPositionForValue(t,e){return this.getPointPosition(t,this.getDistanceFromCenterForValue(e))}getBasePosition(t){return this.getPointPositionForValue(t||0,this.getBaseValue())}getPointLabelPosition(t){const{left:e,top:s,right:i,bottom:r}=this._pointLabelItems[t];return{left:e,top:s,right:i,bottom:r}}drawBackground(){const{backgroundColor:t,grid:{circular:e}}=this.options;if(t){const s=this.ctx;s.save(),s.beginPath(),My(this,this.getDistanceFromCenterForValue(this._endValue),e,this._pointLabels.length),s.closePath(),s.fillStyle=t,s.fill(),s.restore()}}drawGrid(){const t=this.ctx,e=this.options,{angleLines:s,grid:i,border:r}=e,o=this._pointLabels.length;let a,l,u;if(e.pointLabels.display&&DC(this,o),i.display&&this.ticks.forEach((h,d)=>{if(d!==0||d===0&&this.min<0){l=this.getDistanceFromCenterForValue(h.value);const p=this.getContext(d),m=i.setContext(p),_=r.setContext(p);OC(this,m,l,o,_)}}),s.display){for(t.save(),a=o-1;a>=0;a--){const h=s.setContext(this.getPointLabelContext(a)),{color:d,lineWidth:p}=h;!p||!d||(t.lineWidth=p,t.strokeStyle=d,t.setLineDash(h.borderDash),t.lineDashOffset=h.borderDashOffset,l=this.getDistanceFromCenterForValue(e.reverse?this.min:this.max),u=this.getPointPosition(a,l),t.beginPath(),t.moveTo(this.xCenter,this.yCenter),t.lineTo(u.x,u.y),t.stroke())}t.restore()}}drawBorder(){}drawLabels(){const t=this.ctx,e=this.options,s=e.ticks;if(!s.display)return;const i=this.getIndexAngle(0);let r,o;t.save(),t.translate(this.xCenter,this.yCenter),t.rotate(i),t.textAlign="center",t.textBaseline="middle",this.ticks.forEach((a,l)=>{if(l===0&&this.min>=0&&!e.reverse)return;const u=s.setContext(this.getContext(l)),h=Vt(u.font);if(r=this.getDistanceFromCenterForValue(this.ticks[l].value),u.showLabelBackdrop){t.font=h.string,o=t.measureText(a.label).width,t.fillStyle=u.backdropColor;const d=se(u.backdropPadding);t.fillRect(-o/2-d.left,-r-h.size/2-d.top,o+d.width,h.size+d.height)}ms(t,a.label,0,-r,h,{color:u.color,strokeColor:u.textStrokeColor,strokeWidth:u.textStrokeWidth})}),t.restore()}drawTitle(){}}B($i,"id","radialLinear"),B($i,"defaults",{display:!0,animate:!0,position:"chartArea",angleLines:{display:!0,lineWidth:1,borderDash:[],borderDashOffset:0},grid:{circular:!1},startAngle:0,ticks:{showLabelBackdrop:!0,callback:$a.formatters.numeric},pointLabels:{backdropColor:void 0,backdropPadding:2,display:!0,font:{size:10},callback(t){return t},padding:5,centerPointLabels:!1}}),B($i,"defaultRoutes",{"angleLines.color":"borderColor","pointLabels.color":"color","ticks.color":"color"}),B($i,"descriptors",{angleLines:{_fallback:"grid"}});const Ga={millisecond:{common:!0,size:1,steps:1e3},second:{common:!0,size:1e3,steps:60},minute:{common:!0,size:6e4,steps:60},hour:{common:!0,size:36e5,steps:24},day:{common:!0,size:864e5,steps:30},week:{common:!1,size:6048e5,steps:4},month:{common:!0,size:2628e6,steps:12},quarter:{common:!1,size:7884e6,steps:4},year:{common:!0,size:3154e7}},pe=Object.keys(Ga);function Wp(n,t){return n-t}function qp(n,t){if(Y(t))return null;const e=n._adapter,{parser:s,round:i,isoWeekday:r}=n._parseOpts;let o=t;return typeof s=="function"&&(o=s(o)),It(o)||(o=typeof s=="string"?e.parse(o,s):e.parse(o)),o===null?null:(i&&(o=i==="week"&&(Zs(r)||r===!0)?e.startOf(o,"isoWeek",r):e.startOf(o,i)),+o)}function Gp(n,t,e,s){const i=pe.length;for(let r=pe.indexOf(n);r<i-1;++r){const o=Ga[pe[r]],a=o.steps?o.steps:Number.MAX_SAFE_INTEGER;if(o.common&&Math.ceil((e-t)/(a*o.size))<=s)return pe[r]}return pe[i-1]}function LC(n,t,e,s,i){for(let r=pe.length-1;r>=pe.indexOf(e);r--){const o=pe[r];if(Ga[o].common&&n._adapter.diff(i,s,o)>=t-1)return o}return pe[e?pe.indexOf(e):0]}function NC(n){for(let t=pe.indexOf(n)+1,e=pe.length;t<e;++t)if(Ga[pe[t]].common)return pe[t]}function Kp(n,t,e){if(!e)n[t]=!0;else if(e.length){const{lo:s,hi:i}=Gu(e,t),r=e[s]>=t?e[s]:e[i];n[r]=!0}}function VC(n,t,e,s){const i=n._adapter,r=+i.startOf(t[0].value,s),o=t[t.length-1].value;let a,l;for(a=r;a<=o;a=+i.add(a,1,s))l=e[a],l>=0&&(t[l].major=!0);return t}function Yp(n,t,e){const s=[],i={},r=t.length;let o,a;for(o=0;o<r;++o)a=t[o],i[a]=o,s.push({value:a,major:!1});return r===0||!e?s:VC(n,s,i,e)}class mr extends xs{constructor(t){super(t),this._cache={data:[],labels:[],all:[]},this._unit="day",this._majorUnit=void 0,this._offsets={},this._normalized=!1,this._parseOpts=void 0}init(t,e={}){const s=t.time||(t.time={}),i=this._adapter=new WR._date(t.adapters.date);i.init(e),Ki(s.displayFormats,i.formats()),this._parseOpts={parser:s.parser,round:s.round,isoWeekday:s.isoWeekday},super.init(t),this._normalized=e.normalized}parse(t,e){return t===void 0?null:qp(this,t)}beforeLayout(){super.beforeLayout(),this._cache={data:[],labels:[],all:[]}}determineDataLimits(){const t=this.options,e=this._adapter,s=t.time.unit||"day";let{min:i,max:r,minDefined:o,maxDefined:a}=this.getUserBounds();function l(u){!o&&!isNaN(u.min)&&(i=Math.min(i,u.min)),!a&&!isNaN(u.max)&&(r=Math.max(r,u.max))}(!o||!a)&&(l(this._getLabelBounds()),(t.bounds!=="ticks"||t.ticks.source!=="labels")&&l(this.getMinMax(!1))),i=It(i)&&!isNaN(i)?i:+e.startOf(Date.now(),s),r=It(r)&&!isNaN(r)?r:+e.endOf(Date.now(),s)+1,this.min=Math.min(i,r-1),this.max=Math.max(i+1,r)}_getLabelBounds(){const t=this.getLabelTimestamps();let e=Number.POSITIVE_INFINITY,s=Number.NEGATIVE_INFINITY;return t.length&&(e=t[0],s=t[t.length-1]),{min:e,max:s}}buildTicks(){const t=this.options,e=t.time,s=t.ticks,i=s.source==="labels"?this.getLabelTimestamps():this._generate();t.bounds==="ticks"&&i.length&&(this.min=this._userMin||i[0],this.max=this._userMax||i[i.length-1]);const r=this.min,o=this.max,a=gS(i,r,o);return this._unit=e.unit||(s.autoSkip?Gp(e.minUnit,this.min,this.max,this._getLabelCapacity(r)):LC(this,a.length,e.minUnit,this.min,this.max)),this._majorUnit=!s.major.enabled||this._unit==="year"?void 0:NC(this._unit),this.initOffsets(i),t.reverse&&a.reverse(),Yp(this,a,this._majorUnit)}afterAutoSkip(){this.options.offsetAfterAutoskip&&this.initOffsets(this.ticks.map(t=>+t.value))}initOffsets(t=[]){let e=0,s=0,i,r;this.options.offset&&t.length&&(i=this.getDecimalForValue(t[0]),t.length===1?e=1-i:e=(this.getDecimalForValue(t[1])-i)/2,r=this.getDecimalForValue(t[t.length-1]),t.length===1?s=r:s=(r-this.getDecimalForValue(t[t.length-2]))/2);const o=t.length<3?.5:.25;e=Ut(e,0,o),s=Ut(s,0,o),this._offsets={start:e,end:s,factor:1/(e+1+s)}}_generate(){const t=this._adapter,e=this.min,s=this.max,i=this.options,r=i.time,o=r.unit||Gp(r.minUnit,e,s,this._getLabelCapacity(e)),a=G(i.ticks.stepSize,1),l=o==="week"?r.isoWeekday:!1,u=Zs(l)||l===!0,h={};let d=e,p,m;if(u&&(d=+t.startOf(d,"isoWeek",l)),d=+t.startOf(d,u?"day":o),t.diff(s,e,o)>1e5*a)throw new Error(e+" and "+s+" are too far apart with stepSize of "+a+" "+o);const _=i.ticks.source==="data"&&this.getDataTimestamps();for(p=d,m=0;p<s;p=+t.add(p,a,o),m++)Kp(h,p,_);return(p===s||i.bounds==="ticks"||m===1)&&Kp(h,p,_),Object.keys(h).sort(Wp).map(v=>+v)}getLabelForValue(t){const e=this._adapter,s=this.options.time;return s.tooltipFormat?e.format(t,s.tooltipFormat):e.format(t,s.displayFormats.datetime)}format(t,e){const i=this.options.time.displayFormats,r=this._unit,o=e||i[r];return this._adapter.format(t,o)}_tickFormatFunction(t,e,s,i){const r=this.options,o=r.ticks.callback;if(o)return ht(o,[t,e,s],this);const a=r.time.displayFormats,l=this._unit,u=this._majorUnit,h=l&&a[l],d=u&&a[u],p=s[e],m=u&&d&&p&&p.major;return this._adapter.format(t,i||(m?d:h))}generateTickLabels(t){let e,s,i;for(e=0,s=t.length;e<s;++e)i=t[e],i.label=this._tickFormatFunction(i.value,e,t)}getDecimalForValue(t){return t===null?NaN:(t-this.min)/(this.max-this.min)}getPixelForValue(t){const e=this._offsets,s=this.getDecimalForValue(t);return this.getPixelForDecimal((e.start+s)*e.factor)}getValueForPixel(t){const e=this._offsets,s=this.getDecimalForPixel(t)/e.factor-e.end;return this.min+s*(this.max-this.min)}_getLabelSize(t){const e=this.options.ticks,s=this.ctx.measureText(t).width,i=Ae(this.isHorizontal()?e.maxRotation:e.minRotation),r=Math.cos(i),o=Math.sin(i),a=this._resolveTickFontOptions(0).size;return{w:s*r+a*o,h:s*o+a*r}}_getLabelCapacity(t){const e=this.options.time,s=e.displayFormats,i=s[e.unit]||s.millisecond,r=this._tickFormatFunction(t,0,Yp(this,[t],this._majorUnit),i),o=this._getLabelSize(r),a=Math.floor(this.isHorizontal()?this.width/o.w:this.height/o.h)-1;return a>0?a:1}getDataTimestamps(){let t=this._cache.data||[],e,s;if(t.length)return t;const i=this.getMatchingVisibleMetas();if(this._normalized&&i.length)return this._cache.data=i[0].controller.getAllParsedValues(this);for(e=0,s=i.length;e<s;++e)t=t.concat(i[e].controller.getAllParsedValues(this));return this._cache.data=this.normalize(t)}getLabelTimestamps(){const t=this._cache.labels||[];let e,s;if(t.length)return t;const i=this.getLabels();for(e=0,s=i.length;e<s;++e)t.push(qp(this,i[e]));return this._cache.labels=this._normalized?t:this.normalize(t)}normalize(t){return q_(t.sort(Wp))}}B(mr,"id","time"),B(mr,"defaults",{bounds:"data",adapters:{},time:{parser:!1,unit:!1,round:!1,isoWeekday:!1,minUnit:"millisecond",displayFormats:{}},ticks:{source:"auto",callback:!1,major:{enabled:!1}}});function vo(n,t,e){let s=0,i=n.length-1,r,o,a,l;e?(t>=n[s].pos&&t<=n[i].pos&&({lo:s,hi:i}=on(n,"pos",t)),{pos:r,time:a}=n[s],{pos:o,time:l}=n[i]):(t>=n[s].time&&t<=n[i].time&&({lo:s,hi:i}=on(n,"time",t)),{time:r,pos:a}=n[s],{time:o,pos:l}=n[i]);const u=o-r;return u?a+(l-a)*(t-r)/u:a}class Bc extends mr{constructor(t){super(t),this._table=[],this._minPos=void 0,this._tableRange=void 0}initOffsets(){const t=this._getTimestampsForTable(),e=this._table=this.buildLookupTable(t);this._minPos=vo(e,this.min),this._tableRange=vo(e,this.max)-this._minPos,super.initOffsets(t)}buildLookupTable(t){const{min:e,max:s}=this,i=[],r=[];let o,a,l,u,h;for(o=0,a=t.length;o<a;++o)u=t[o],u>=e&&u<=s&&i.push(u);if(i.length<2)return[{time:e,pos:0},{time:s,pos:1}];for(o=0,a=i.length;o<a;++o)h=i[o+1],l=i[o-1],u=i[o],Math.round((h+l)/2)!==u&&r.push({time:u,pos:o/(a-1)});return r}_generate(){const t=this.min,e=this.max;let s=super.getDataTimestamps();return(!s.includes(t)||!s.length)&&s.splice(0,0,t),(!s.includes(e)||s.length===1)&&s.push(e),s.sort((i,r)=>i-r)}_getTimestampsForTable(){let t=this._cache.all||[];if(t.length)return t;const e=this.getDataTimestamps(),s=this.getLabelTimestamps();return e.length&&s.length?t=this.normalize(e.concat(s)):t=e.length?e:s,t=this._cache.all=t,t}getDecimalForValue(t){return(vo(this._table,t)-this._minPos)/this._tableRange}getValueForPixel(t){const e=this._offsets,s=this.getDecimalForPixel(t)/e.factor-e.end;return vo(this._table,s*this._tableRange+this._minPos,!0)}}B(Bc,"id","timeseries"),B(Bc,"defaults",mr.defaults);var FC=Object.freeze({__proto__:null,CategoryScale:Lc,LinearScale:Nc,LogarithmicScale:Vc,RadialLinearScale:$i,TimeScale:mr,TimeSeriesScale:Bc});const BC=[HR,bP,gC,FC];_t.register(...BC);const bo="rgba(255,255,255,0.08)",wo="#a1a1aa",vn={family:"Rajdhani, Inter, system-ui, sans-serif",weight:"600"};_t.defaults.color="#e5e5e5";_t.defaults.font.family=vn.family;_t.defaults.font.weight=vn.weight;const Xp={renderCurvaS:(n,t=[],e=[])=>{const s=document.getElementById(n);if(!s)return;s.chart&&s.chart.destroy();const i=t.map((r,o)=>`M${o+1}`);s.chart=new _t(s,{type:"line",data:{labels:i,datasets:[{label:"Planejado",data:t,borderColor:"#16a34a",backgroundColor:"rgba(34, 197, 94, 0.15)",tension:.35,fill:!0,borderWidth:3},{label:"Realizado",data:e,borderColor:"#22c55e",backgroundColor:"rgba(34, 197, 94, 0.05)",tension:.35,fill:!0,borderWidth:3}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{position:"bottom",labels:{color:"#e5e5e5",font:vn,usePointStyle:!0}}},scales:{x:{grid:{color:bo},ticks:{color:wo,font:vn}},y:{grid:{color:bo},ticks:{color:wo,font:vn}}}}})},renderGastosPorMes:(n,t)=>{const e=document.getElementById(n);if(!e)return;const s=Object.keys(t).sort(),i=s.map(r=>t[r]);e.chart&&e.chart.destroy(),e.chart=new _t(e,{type:"bar",data:{labels:s,datasets:[{label:"Gastos (R$)",data:i,backgroundColor:"#22c55e",borderRadius:0}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1}},scales:{x:{grid:{color:bo},ticks:{color:wo,font:vn}},y:{grid:{color:bo},ticks:{color:wo,font:vn}}}}})},renderStatusPie:(n,t)=>{const e=document.getElementById(n);if(!e)return;const s=Object.keys(t),i=Object.values(t);e.chart&&e.chart.destroy(),e.chart=new _t(e,{type:"doughnut",data:{labels:s,datasets:[{data:i,backgroundColor:["#22c55e","#16a34a","#a1a1aa","#ef4444","#1c1c1e"]}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{position:"bottom",labels:{color:"#e5e5e5",font:vn,padding:12,usePointStyle:!0}}}}})}},me={dashboard:'<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6"><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6A2.25 2.25 0 016 3.75h2.25A2.25 2.25 0 0110.5 6v2.25a2.25 2.25 0 01-2.25 2.25H6a2.25 2.25 0 01-2.25-2.25V6zM3.75 15.75A2.25 2.25 0 016 13.5h2.25a2.25 2.25 0 012.25 2.25V18a2.25 2.25 0 01-2.25 2.25H6A2.25 2.25 0 013.75 18v-2.25zM13.5 6a2.25 2.25 0 012.25-2.25H18A2.25 2.25 0 0120.25 6v2.25A2.25 2.25 0 0118 10.5h-2.25a2.25 2.25 0 01-2.25-2.25V6zM13.5 15.75a2.25 2.25 0 012.25-2.25H18a2.25 2.25 0 012.25 2.25V18A2.25 2.25 0 0118 20.25h-2.25A2.25 2.25 0 0113.5 18v-2.25z" /></svg>',shoppingCart:'<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 00-16.536-1.84M7.5 14.25L5.106 5.272M6 20.25a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm12.75 0a.75.75 0 11-1.5 0 .75.75 0 011.5 0z" /></svg>',clipboard:'<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 002.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 00-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 00.75-.75 2.25 2.25 0 00-.1-.664m-5.8 0A2.251 2.251 0 0113.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m0 0H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V9.375c0-.621-.504-1.125-1.125-1.125H8.25zM6.75 12h.008v.008H6.75V12zm0 3h.008v.008H6.75V15zm0 3h.008v.008H6.75V18z" /></svg>',chart:'<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6"><path stroke-linecap="round" stroke-linejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 013 19.875v-6.75zM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V8.625zM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V4.125z" /></svg>',settings:'<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6"><path stroke-linecap="round" stroke-linejoin="round" d="M9.594 3.94c.09-.542.56-.94 1.11-.94h2.593c.55 0 1.02.398 1.11.94l.213 1.281c.063.374.313.686.645.87.074.04.147.083.22.127.324.196.72.257 1.075.124l1.217-.456a1.125 1.125 0 011.37.49l1.296 2.247a1.125 1.125 0 01-.26 1.431l-1.003.827c-.293.24-.438.613-.431.992a6.759 6.759 0 010 .255c-.007.378.138.75.43.99l1.005.828c.424.35.534.954.26 1.43l-1.298 2.247a1.125 1.125 0 01-1.369.491l-1.217-.456c-.355-.133-.75-.072-1.076.124a6.57 6.57 0 01-.22.128c-.331.183-.581.495-.644.869l-.212 1.28c-.09.543-.56.941-1.11.941h-2.594c-.55 0-1.02-.398-1.11-.94l-.213-1.281c-.062-.374-.312-.686-.644-.87a6.52 6.52 0 01-.22-.127c-.325-.196-.72-.257-1.076-.124l-1.217.456a1.125 1.125 0 01-1.369-.49l-1.297-2.247a1.125 1.125 0 01.26-1.431l1.004-.827c.292-.24.437-.613.43-.992a6.932 6.932 0 010-.255c.007-.378-.138-.75-.43-.99l-1.004-.828a1.125 1.125 0 01-.26-1.43l1.297-2.247a1.125 1.125 0 011.37-.491l1.216.456c.356.133.751.072 1.076-.124.072-.044.146-.087.22-.128.332-.183.582-.495.644-.869l.214-1.281z" /><path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /></svg>',logout:'<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6"><path stroke-linecap="round" stroke-linejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0013.5 3h-6a2.25 2.25 0 00-2.25 2.25v13.5A2.25 2.25 0 007.5 21h6a2.25 2.25 0 002.25-2.25V15M12 9l-3 3m0 0l3 3m-3-3h12.75" /></svg>',menu:'<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6"><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" /></svg>',search:'<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5"><path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" /></svg>',bell:'<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"/></svg>',sun:'<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6"><path stroke-linecap="round" stroke-linejoin="round" d="M12 3v2.25m6.364.386l-1.591 1.591M21 12h-2.25m-.386 6.364l-1.591-1.591M12 18.75V21m-4.773-4.227l-1.591 1.591M5.25 12H3m4.227-4.773L5.636 5.636M15.75 12a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0z" /></svg>',moon:'<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6"><path stroke-linecap="round" stroke-linejoin="round" d="M21.752 15.002A9.718 9.718 0 0118 15.75c-5.385 0-9.75-4.365-9.75-9.75 0-1.33.266-2.597.748-3.752A9.753 9.753 0 003 11.25C3 16.635 7.365 21 12.75 21a9.753 9.753 0 009.002-5.998z" /></svg>'},rt={render:n=>{const t=document.getElementById("app"),e=dt.state.currentUser;if(!e){t.innerHTML=n;return}const s=dt.state.sidebarCollapsed,i=dt.state.currentTheme;t.innerHTML=`
                        ...
                        <tbody class="divide-y divide-border">
                            ${n.map(t=>`
                                <tr class="hover:bg-canvas transition-colors">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-text-muted">${de.formatDate(t.data_solicitacao)}</td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-text-muted">${de.formatCurrency(t.valor_estimado||0)}</td>
                                ...
                                ${s.map(i=>`
                                    <div class="bg-surface p-4 rounded shadow-heavy border border-border cursor-move hover:border-primary transition-colors" draggable="true" data-id="${i.id}">
                                        <div class="flex justify-between items-start mb-2">
                                            ...
                                            <span class="text-xs text-text-muted">${de.formatDate(i.data_solicitacao)}</span>
                                        </div>
                                        <p class="text-sm font-display text-text mb-2 line-clamp-2">${i.descricao}</p>
                                        <div class="flex justify-between items-center mt-3">
                                            <span class="text-sm font-display text-primary uppercase">${de.formatCurrency(i.valor_estimado||0)}</span>
        ...
        `;for(let d=0;d<l;d++)h+='<div class="aspect-square"></div>';for(let d=1;d<=a;d++){const p=new Date(s,e,d),m=p.toISOString().split("T")[0],_=i[m]||[],v=d===t.getDate()&&e===t.getMonth(),y=p<t&&!v;h+=`
                    ...
                    ${n.map(t=>`
                        <div class="card hover:shadow-heavy transition-shadow cursor-pointer" onclick="window.location.hash = '/obras/${t.id}'">
                            ...
                            <div class="space-y-2 text-sm text-text">
                                ...
                                ${t.orcamento?`<p class="heading-muted"><span class="text-text">Orçamento:</span> ${de.formatCurrency(t.orcamento)}</p>`:""}
                            </div>
        ...
        `},renderDashboard:(n,t)=>`
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
                    ...
                    ${U.createCard({title:"Total Gasto",content:`<p class="text-4xl font-display text-text uppercase">${de.formatCurrency(t.totalGasto)}</p><p class="text-sm heading-muted mt-1">Orçamento: ${de.formatCurrency(n.orcamento||0)}</p>`})}
                    ...
                    ${U.createCard({title:"Economia vs Orçamento",content:`<p class="text-4xl font-display text-${(t.economia||0)<0?"alert":"primary"} uppercase">${de.formatCurrency(t.economia||0)}</p><p class="text-sm heading-muted mt-1">% Curva: ${(t.curvaPercent||0).toFixed(1)}%</p>`})}
                </div>
                            ...
                            <tbody class="divide-y divide-border">
                                ${t.comprasRecentes.map(e=>`
                                    <tr class="hover:bg-canvas">
                                        <td class="px-6 py-4 text-sm text-text-muted">${de.formatDate(e.data_solicitacao)}</td>
                                        <td class="px-6 py-4 text-sm text-text">${e.descricao||"-"}</td>
                                        <td class="px-6 py-4 text-sm text-text-muted">${de.formatCurrency(e.valor_estimado||0)}</td>
