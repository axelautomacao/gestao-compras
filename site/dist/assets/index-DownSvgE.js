...
*/var Ts,vg;(function(){var n;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function t(E,y){function x(){}x.prototype=y.prototype,E.D=y.prototype,E.prototype=new x,E.prototype.constructor=E,E.C=function(A,R,S){for(var k=Array(arguments.length-2),ct=2;ct<arguments.length;ct++)k[ct-2]=arguments[ct];return y.prototype[R].apply(A,k)}}function e(){this.blockSize=-1}function s(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}t(s,e),s.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function i(E,y,x){x||(x=0);var A=Array(16);if(typeof y=="string")for(var R=0;16>R;++R)A[R]=y.charCodeAt(x++)|y.charCodeAt(x++)<<8|y.charCodeAt(x++)<<16|y.charCodeAt(x++)<<24;else for(R=0;16>R;++R)A[R]=y[x++]|y[x++]<<8|y[x++]<<16|y[x++]<<24;y=E.g[0],x=E.g[1],R=E.g[2];var S=E.g[3],k=y+(S^x&(R^S))+A[0]+3614090360&4294967295;y=x+(k<<7&4294967295|k>>>25),k=S+(R^y&(x^R))+A[1]+3905402710&4294967295,S=y+(k<<12&4294967295|k>>>20),k=R+(x^S&(y^x))+A[2]+606105819&4294967295,R=S+(k<<17&4294967295|k>>>15),k=x+(y^R&(S^y))+A[3]+3250441966&4294967295,x=R+(k<<22&4294967295|k>>>10),k=y+(S^x&(R^S))+A[4]+4118548399&4294967295,y=x+(k<<7&4294967295|k>>>25),k=S+(R^y&(x^R))+A[5]+1200080426&4294967295,S=y+(k<<12&4294967295|k>>>20),k=R+(x^S&(y^x))+A[6]+2821735955&4294967295,R=S+(k<<17&4294967295|k>>>15),k=x+(y^R&(S^y))+A[7]+4249261313&4294967295,x=R+(k<<22&4294967295|k>>>10),k=y+(S^x&(R^S))+A[8]+1770035416&4294967295,y=x+(k<<7&4294967295|k>>>25),k=S+(R^y&(x^R))+A[9]+2336552879&4294967295,S=y+(k<<12&4294967295|k>>>20),k=R+(x^S&(y^x))+A[10]+4294925233&4294967295,R=S+(k<<17&4294967295|k>>>15),k=x+(y^R&(S^y))+A[11]+2304563134&4294967295,x=R+(k<<22&4294967295|k>>>10),k=y+(S^x&(R^S))+A[12]+1804603682&4294967295,y=x+(k<<7&4294967295|k>>>25),k=S+(R^y&(x^R))+A[13]+4254626195&4294967295,S=y+(k<<12&4294967295|k>>>20),k=R+(x^S&(y^x))+A[14]+2792965006&4294967295,R=S+(k<<17&4294967295|k>>>15),k=x+(y^R&(S^y))+A[15]+1236535329&4294967295,x=R+(k<<22&4294967295|k>>>10),k=y+(R^S&(x^R))+A[1]+4129170786&4294967295,y=x+(k<<5&4294967295|k>>>27),k=S+(x^R&(y^x))+A[6]+3225465664&4294967295,S=y+(k<<9&4294967295|k>>>23),k=R+(y^x&(S^y))+A[11]+643717713&4294967295,R=S+(k<<14&4294967295|k>>>18),k=x+(S^y&(R^S))+A[0]+3921069994&4294967295,x=R+(k<<20&4294967295|k>>>12),k=y+(R^S&(x^R))+A[5]+3593408605&4294967295,y=x+(k<<5&4294967295|k>>>27),k=S+(x^R&(y^x))+A[10]+38016083&4294967295,S=y+(k<<9&4294967295|k>>>23),k=R+(y^x&(S^y))+A[15]+3634488961&4294967295,R=S+(k<<14&4294967295|k>>>18),k=x+(S^y&(R^S))+A[4]+3889429448&4294967295,x=R+(k<<20&4294967295|k>>>12),k=y+(R^S&(x^R))+A[9]+568446438&4294967295,y=x+(k<<5&4294967295|k>>>27),k=S+(x^R&(y^x))+A[14]+3275163606&4294967295,S=y+(k<<9&4294967295|k>>>23),k=R+(y^x&(S^y))+A[3]+4107603335&4294967295,R=S+(k<<14&4294967295|k>>>18),k=x+(S^y&(R^S))+A[8]+1163531501&4294967295,x=R+(k<<20&4294967295|k>>>12),k=y+(R^S&(x^R))+A[13]+2850285829&4294967295,y=x+(k<<5&4294967295|k>>>27),k=S+(x^R&(y^x))+A[2]+4243563512&4294967295,S=y+(k<<9&4294967295|k>>>23),k=R+(y^x&(S^y))+A[7]+1735328473&4294967295,R=S+(k<<14&4294967295|k>>>18),k=x+(S^y&(R^S))+A[12]+2368359562&4294967295,x=R+(k<<20&4294967295|k>>>12),k=y+(x^R^S)+A[5]+4294588738&4294967295,y=x+(k<<4&4294967295|k>>>28),k=S+(y^x^R)+A[8]+2272392833&4294967295,S=y+(k<<11&4294967295|k>>>21),k=R+(S^y^x)+A[11]+1839030562&4294967295,R=S+(k<<16&4294967295|k>>>16),k=x+(R^S^y)+A[14]+4259657740&4294967295,x=R+(k<<23&4294967295|k>>>9),k=y+(x^R^S)+A[1]+2763975236&4294967295,y=x+(k<<4&4294967295|k>>>28),k=S+(y^x^R)+A[4]+1272893353&4294967295,S=y+(k<<11&4294967295|k>>>21),k=R+(S^y^x)+A[7]+4139469664&4294967295,R=S+(k<<16&4294967295|k>>>16),k=x+(R^S^y)+A[10]+3200236656&4294967295,x=R+(k<<23&4294967295|k>>>9),k=y+(x^R^S)+A[13]+681279174&4294967295,y=x+(k<<4&4294967295|k>>>28),k=S+(y^x^R)+A[0]+3936430074&4294967295,S=y+(k<<11&4294967295|k>>>21),k=R+(S^y^x)+A[3]+3572445317&4294967295,R=S+(k<<16&4294967295|k>>>16),k=x+(R^S^y)+A[6]+76029189&4294967295,x=R+(k<<23&4294967295|k>>>9),k=y+(x^R^S)+A[9]+3654602809&4294967295,y=x+(k<<4&4294967295|k>>>28),k=S+(y^x^R)+A[12]+3873151461&4294967295,S=y+(k<<11&4294967295|k>>>21),k=R+(S^y^x)+A[15]+530742520&4294967295,R=S+(k<<16&4294967295|k>>>16),k=x+(R^S^y)+A[2]+3299628645&4294967295,x=R+(k<<23&4294967295|k>>>9),k=y+(R^(x|~S))+A[0]+4096336452&4294967295,y=x+(k<<6&4294967295|k>>>26),k=S+(x^(y|~R))+A[7]+1126891415&4294967295,S=y+(k<<10&4294967295|k>>>22),k=R+(y^(S|~x))+A[14]+2878612391&4294967295,R=S+(k<<15&4294967295|k>>>17),k=x+(S^(R|~y))+A[5]+4237533241&4294967295,x=R+(k<<21&4294967295|k>>>11),k=y+(R^(x|~S))+A[12]+1700485571&4294967295,y=x+(k<<6&4294967295|k>>>26),k=S+(x^(y|~R))+A[3]+2399980690&4294967295,S=y+(k<<10&4294967295|k>>>22),k=R+(y^(S|~x))+A[10]+4293915773&4294967295,R=S+(k<<15&4294967295|k>>>17),k=x+(S^(R|~y))+A[1]+2240044497&4294967295,x=R+(k<<21&4294967295|k>>>11),k=y+(R^(x|~S))+A[8]+1873313359&4294967295,y=x+(k<<6&4294967295|k>>>26),k=S+(x^(y|~R))+A[15]+4264355552&4294967295,S=y+(k<<10&4294967295|k>>>22),k=R+(y^(S|~x))+A[6]+2734768916&4294967295,R=S+(k<<15&4294967295|k>>>17),k=x+(S^(R|~y))+A[13]+1309151649&4294967295,x=R+(k<<21&4294967295|k>>>11),k=y+(R^(x|~S))+A[4]+4149444226&4294967295,y=x+(k<<6&4294967295|k>>>26),k=S+(x^(y|~R))+A[11]+3174756917&4294967295,S=y+(k<<10&4294967295|k>>>22),k=R+(y^(S|~x))+A[2]+718787259&4294967295,R=S+(k<<15&4294967295|k>>>17),k=x+(S^(R|~y))+A[9]+3951481745&4294967295,E.g[0]=E.g[0]+y&4294967295,E.g[1]=E.g[1]+(R+(k<<21&4294967295|k>>>11))&4294967295,E.g[2]=E.g[2]+R&4294967295,E.g[3]=E.g[3]+S&4294967295}s.prototype.u=function(E,y){y===void 0&&(y=E.length);for(var x=y-this.blockSize,A=this.B,R=this.h,S=0;S<y;){if(R==0)for(;S<=x;)i(this,E,S),S+=this.blockSize;if(typeof E=="string"){for(;S<y;)if(A[R++]=E.charCodeAt(S++),R==this.blockSize){i(this,A),R=0;break}}else for(;S<y;)if(A[R++]=E[S++],R==this.blockSize){i(this,A),R=0;break}}this.h=R,this.o+=y},s.prototype.v=function(){var E=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);E[0]=128;for(var y=1;y<E.length-8;++y)E[y]=0;var x=8*this.o;for(y=E.length-8;y<E.length;++y)E[y]=x&255,x/=256;for(this.u(E),E=Array(16),y=x=0;4>y;++y)for(var A=0;32>A;A+=8)E[x++]=this.g[y]>>>A&255;return E};function r(E,y){var x=a;return Object.prototype.hasOwnProperty.call(x,E)?x[E]:x[E]=y(E)}function o(E,y){this.h=y;for(var x=[],A=!0,R=E.length-1;0<=R;R--){var S=E[R]|0;A&&S==y||(x[R]=S,A=!1)}this.g=x}var a={};function c(E){return-128<=E&&128>E?r(E,function(y){return new o([y|0],0>y?-1:0)}):new o([E|0],0>E?-1:0)}function l(E){if(isNaN(E)||!isFinite(E))return h;if(0>E)return v(l(-E));for(var y=[],x=1,A=0;E>=x;A++)y[A]=E/x|0,x*=4294967296;return new o(y,0)}function d(E,y){if(E.length==0)throw Error("number format error: empty string");if(y=y||10,2>y||36<y)throw Error("radix out of range: "+y);if(E.charAt(0)=="-")return v(d(E.substring(1),y));if(0<=E.indexOf("-"))throw Error('number format error: interior "-" character');for(var x=l(Math.pow(y,8)),A=h,R=0;R<E.length;R+=8){var S=Math.min(8,E.length-R),k=parseInt(E.substring(R,R+S),y);8>S?(S=l(Math.pow(y,S)),A=A.j(S).add(l(k))):(A=A.j(x),A=A.add(l(k)))}return A}var h=c(0),f=c(1),m=c(16777216);n=o.prototype,n.m=function(){if(b(this))return-v(this).m();for(var E=0,y=1,x=0;x<this.g.length;x++){var A=this.i(x);E+=(0<=A?A:4294967296+A)*y,y*=4294967296}return E},n.toString=function(E){if(E=E||10,2>E||36<E)throw Error("radix out of range: "+E);if(_(this))return"0";if(b(this))return"-"+v(this).toString(E);for(var y=l(Math.pow(E,6)),x=this,A="";;){var R=P(x,y).g;x=T(x,R.j(y));var S=((0<x.g.length?x.g[0]:x.h)>>>0).toString(E);if(x=R,_(x))return S+A;for(;6>S.length;)S="0"+S;A=S+A}},n.i=function(E){return 0>E?0:E<this.g.length?this.g[E]:this.h};function _(E){if(E.h!=0)return!1;for(var y=0;y<E.g.length;y++)if(E.g[y]!=0)return!1;return!0}function b(E){return E.h==-1}n.l=function(E){return E=T(this,E),b(E)?-1:_(E)?0:1};function v(E){for(var y=E.g.length,x=[],A=0;A<y;A++)x[A]=~E.g[A];return new o(x,~E.h).add(f)}n.abs=function(){return b(this)?v(this):this},n.add=function(E){for(var y=Math.max(this.g.length,E.g.length),x=[],A=0,R=0;R<=y;R++){var S=A+(this.i(R)&65535)+(E.i(R)&65535),k=(S>>>16)+(this.i(R)>>>16)+(E.i(R)>>>16);A=k>>>16,S&=65535,k&=65535,x[R]=k<<16|S}return new o(x,x[x.length-1]&-2147483648?-1:0)};function T(E,y){return E.add(v(y))}n.j=function(E){if(_(this)||_(E))return h;if(b(this))return b(E)?v(this).j(v(E)):v(v(this).j(E));if(b(E))return v(this.j(v(E)));if(0>this.l(m)&&0>E.l(m))return l(this.m()*E.m());for(var y=this.g.length+E.g.length,x=[],A=0;A<2*y;A++)x[A]=0;for(A=0;A<this.g.length;A++)for(var R=0;R<E.g.length;R++){var S=this.i(A)>>>16,k=this.i(A)&65535,ct=E.i(R)>>>16,st=E.i(R)&65535;x[2*A+2*R]+=k*st,I(x,2*A+2*R),x[2*A+2*R+1]+=S*st,I(x,2*A+2*R+1),x[2*A+2*R+1]+=k*ct,I(x,2*A+2*R+1),x[2*A+2*R+2]+=S*ct,I(x,2*A+2*R+2)}for(A=0;A<y;A++)x[A]=x[2*A+1]<<16|x[2*A];for(A=y;A<2*y;A++)x[A]=0;return new o(x,0)};function I(E,y){for(;(E[y]&65535)!=E[y];)E[y+1]+=E[y]>>>16,E[y]&=65535,y++}function C(E,y){this.g=E,this.h=y}function P(E,y){if(_(y))throw Error("division by zero");if(_(E))return new C(h,h);if(b(E))return y=P(v(E),y),new C(v(y.g),v(y.h));if(b(y))return y=P(E,v(y)),new C(v(y.g),y.h);if(30<E.g.length){if(b(E)||b(y))throw Error("slowDivide_ only works with positive integers.");for(var x=f,A=y;0>=A.l(E);)x=O(x),A=O(A);var R=M(x,1),S=M(A,1);for(A=M(A,2),x=M(x,2);!_(A);){var k=S.add(A);0>=k.l(E)&&(R=R.add(x),S=k),A=M(A,1),x=M(x,1)}return y=T(E,R.j(y)),new C(R,y)}for(R=h;0<=E.l(y);){for(x=Math.max(1,Math.floor(E.m()/y.m())),A=Math.ceil(Math.log(x)/Math.LN2),A=48>=A?1:Math.pow(2,A-48),S=l(x),k=S.j(y);b(k)||0<k.l(E);)x-=A,S=l(x),k=S.j(y);_(S)&&(S=f),R=R.add(S),E=T(E,k)}return new C(R,E)}n.A=function(E){return P(this,E).h},n.and=function(E){for(var y=Math.max(this.g.length,E.g.length),x=[],A=0;A<y;A++)x[A]=this.i(A)&E.i(A);return new o(x,this.h&E.h)},n.or=function(E){for(var y=Math.max(this.g.length,E.g.length),x=[],A=0;A<y;A++)x[A]=this.i(A)|E.i(A);return new o(x,this.h|E.h)},n.xor=function(E){for(var y=Math.max(this.g.length,E.g.length),x=[],A=0;A<y;A++)x[A]=this.i(A)^E.i(A);return new o(x,this.h^E.h)};function O(E){for(var y=E.g.length+1,x=[],A=0;A<y;A++)x[A]=E.i(A)<<1|E.i(A-1)>>>31;return new o(x,E.h)}function M(E,y){var x=y>>5;y%=32;for(var A=E.g.length-x,R=[],S=0;S<A;S++)R[S]=0<y?E.i(S+x)>>>y|E.i(S+x+1)<<32-y:E.i(S+x);return new o(R,E.h)}s.prototype.digest=s.prototype.v,s.prototype.reset=s.prototype.s,s.prototype.update=s.prototype.u,vg=s,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.A,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=l,o.fromString=d,Ts=o}).apply(typeof hf<"u"?hf:typeof self<"u"?self:typeof window<"u"?window:{});var Co=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Se{constructor(t,e){this.bucket=t,this.path_=e}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const t=encodeURIComponent;return"/b/"+t(this.bucket)+"/o/"+t(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(t,e){let s;try{s=Se.makeFromUrl(t,e)}catch{return new Se(t,"")}if(s.path==="")return s;throw CT(t)}static makeFromUrl(t,e){let s=null;const i="([A-Za-z0-9.\\-_]+)";function r(P){P.path.charAt(P.path.length-1)==="/"&&(P.path_=P.path_.slice(0,-1))}const o="(/(.*))?$",a=new RegExp("^gs://"+i+o,"i"),c={bucket:1,path:3};function l(P){P.path_=decodeURIComponent(P.path)}const d="v[A-Za-z0-9_]+",h=e.replace(/[.]/g,"\\."),f="(/([^?#]*).*)?$",m=new RegExp(`^https?://${h}/${d}/b/${i}/o${f}`,"i"),_={bucket:1,path:3},b=e===j_?"(?:storage.googleapis.com|storage.cloud.google.com)":e,v="([^?#]*)",T=new RegExp(`^https?://${b}/${i}/${v}`,"i"),C=[{regex:a,indices:c,postModify:r},{regex:m,indices:_,postModify:l},{regex:T,indices:{bucket:1,path:2},postModify:l}];for(let P=0;P<C.length;P++){const O=C[P],M=O.regex.exec(t);if(M){const E=M[O.indices.bucket];let y=M[O.indices.path];y||(y=""),s=new Se(E,y),O.postModify(s);break}}if(s==null)throw PT(t);return s}}class VT{constructor(t){this.promise_=Promise.reject(t)}getPromise(){return this.promise_}cancel(t=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
\r
`,f=`\r
--`+c+"--",m=Ln.getBlob(h,s,f);if(m===null)throw q_();const _={name:l.fullPath},b=eo(r,n.host,n._protocol),v="POST",T=n.maxUploadRetryTime,I=new Pi(b,v,xd(n,e),T);return I.urlParams=_,I.headers=o,I.body=m.uploadData(),I.errorHandler=no(t),I}class La{constructor(t,e,s,i){this.current=t,this.total=e,this.finalized=!!s,this.metadata=i||null}}function Ed(n,t){let e=null;try{e=n.getResponseHeader("X-Goog-Upload-Status")}catch{Tn(!1)}return Tn(!!e&&(t||["active"]).indexOf(e)!==-1),e}function gI(n,t,e,s,i){const r=t.bucketOnlyServerUrl(),o=ry(t,s,i),a={name:o.fullPath},c=eo(r,n.host,n._protocol),l="POST",d={"X-Goog-Upload-Protocol":"resumable","X-Goog-Upload-Command":"start","X-Goog-Upload-Header-Content-Length":`${s.size()}`,"X-Goog-Upload-Header-Content-Type":o.contentType,"Content-Type":"application/json; charset=utf-8"},h=sy(o,e),f=n.maxUploadRetryTime;function m(b){Ed(b);let v;try{v=b.getResponseHeader("X-Goog-Upload-URL")}catch{Tn(!1)}return Tn(vc(v)),v}const _=new Pi(c,l,m,f);return _.urlParams=a,_.headers=d,_.body=h,_.errorHandler=no(t),_}function _I(n,t,e,s){const i={"X-Goog-Upload-Command":"query"};function r(l){const d=Ed(l,["active","final"]);let h=null;try{h=l.getResponseHeader("X-Goog-Upload-Size-Received")}catch{Tn(!1)}h||Tn(!1);const f=Number(h);return Tn(!isNaN(f)),new La(f,s.size(),d==="final")}const o="POST",a=n.maxUploadRetryTime,c=new Pi(e,o,r,a);return c.headers=i,c.errorHandler=no(t),c}const tp=256*1024;function yI(n,t,e,s,i,r,o,a){const c=new La(0,0);if(o?(c.current=o.current,c.total=o.total):(c.current=0,c.total=s.size()),s.size()!==c.total)throw OT();const l=c.total-c.current;let d=l;i>0&&(d=Math.min(d,i));const h=c.current,f=h+d;let m="";d===0?m="finalize":l===d?m="upload, finalize":m="upload";const _={"X-Goog-Upload-Command":m,"X-Goog-Upload-Offset":`${c.current}`},b=s.slice(h,f);if(b===null)throw q_();function v(P,O){const M=Ed(P,["active","final"]),E=c.current+d,y=s.size();let x;return M==="final"?x=xd(t,r)(P,O):x=null,new La(E,y,M==="final",x)}const T="POST",I=t.maxUploadRetryTime,C=new Pi(e,T,v,I);return C.headers=_,C.body=b.uploadData(),C.progressCallback=a||null,C.errorHandler=no(n),C}const Ee={RUNNING:"running",PAUSED:"paused",SUCCESS:"success",CANCELED:"canceled",ERROR:"error"};function fl(n){switch(n){case"running":case"pausing":case"canceling":return Ee.RUNNING;case"paused":return Ee.PAUSED;case"success":return Ee.SUCCESS;case"canceled":return Ee.CANCELED;case"error":return Ee.ERROR;default:return Ee.ERROR}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
