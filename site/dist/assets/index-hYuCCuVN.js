 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Uu(n){var t,e;return((e=(((t=n==null?void 0:n.mapValue)===null||t===void 0?void 0:t.fields)||{}).__type__)===null||e===void 0?void 0:e.stringValue)==="server_timestamp"}function $u(n){const t=n.mapValue.fields.__previous_value__;return Uu(t)?$u(t):t}function Sr(n){const t=es(n.mapValue.fields.__local_write_time__.timestampValue);return new $t(t.seconds,t.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tx=new Pt(z.comparator);function Rn(){return tx}const Bg=new Pt(z.comparator);function ar(...n){let t=Bg;for(const e of n)t=t.insert(e.key,e);return t}function Ug(n){let t=Bg;return n.forEach((e,s)=>t=t.insert(e,s.overlayedDocument)),t}function Es(){return yr()}function $g(){return yr()}function yr(){return new ki(n=>n.toString(),(n,t)=>n.isEqual(t))}const ex=new Pt(z.comparator),nx=new ee(z.comparator);function tt(...n){let t=nx;for(const e of n)t=t.add(e);return t}const sx=new ee(ot);function ix(){return sx}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wx{constructor(){this.overlays=new Pt(z.comparator),this.Ir=new Map}getOverlay(t,e){return F.resolve(this.overlays.get(e))}getOverlays(t,e){const s=Es();return F.forEach(e,i=>this.getOverlay(t,i).next(r=>{r!==null&&s.set(i,r)})).next(()=>s)}saveOverlays(t,e,s){return s.forEach((i,r)=>{this.ht(t,e,r)}),F.resolve()}removeOverlaysForBatchId(t,e,s){const i=this.Ir.get(s);return i!==void 0&&(i.forEach(r=>this.overlays=this.overlays.remove(r)),this.Ir.delete(s)),F.resolve()}getOverlaysForCollection(t,e,s){const i=Es(),r=e.length+1,o=new z(e.child("")),a=this.overlays.getIteratorFrom(o);for(;a.hasNext();){const c=a.getNext().value,l=c.getKey();if(!e.isPrefixOf(l.path))break;l.path.length===r&&c.largestBatchId>s&&i.set(c.getKey(),c)}return F.resolve(i)}getOverlaysForCollectionGroup(t,e,s,i){let r=new Pt((l,d)=>l-d);const o=this.overlays.getIterator();for(;o.hasNext();){const l=o.getNext().value;if(l.getKey().getCollectionGroup()===e&&l.largestBatchId>s){let d=r.get(l.largestBatchId);d===null&&(d=Es(),r=r.insert(l.largestBatchId,d)),d.set(l.getKey(),l)}}const a=Es(),c=r.getIterator();for(;c.hasNext()&&(c.getNext().value.forEach((l,d)=>a.set(l,d)),!(a.size()>=i)););return F.resolve(a)}ht(t,e,s){const i=this.overlays.get(s.key);if(i!==null){const o=this.Ir.get(i.largestBatchId).delete(s.key);this.Ir.set(i.largestBatchId,o)}this.overlays=this.overlays.insert(s.key,new px(e,s));let r=this.Ir.get(e);r===void 0&&(r=tt(),this.Ir.set(e,r)),this.Ir.set(e,r.add(s.key))}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function eo(n,t,e){let s=t;return e==null&&(s=`https://${t}`),`${e}://${s}/v0${n}`}function Y_(n){const t=encodeURIComponent;let e="?";for(const s in n)if(n.hasOwnProperty(s)){const i=t(s)+"="+t(n[s]);e=e+i+"&"}return e=e.slice(0,-1),e}var As;(function(n){n[n.NO_ERROR=0]="NO_ERROR",n[n.NETWORK_ERROR=1]="NETWORK_ERROR",n[n.ABORT=2]="ABORT"})(As||(As={}));/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
\r
`,f=`\r
--`+c+"--",m=Vn.getBlob(h,s,f);if(m===null)throw q_();const _={name:l.fullPath},b=eo(r,n.host,n._protocol),v="POST",T=n.maxUploadRetryTime,I=new Si(b,v,xd(n,e),T);return I.urlParams=_,I.headers=o,I.body=m.uploadData(),I.errorHandler=no(t),I}class La{constructor(t,e,s,i){this.current=t,this.total=e,this.finalized=!!s,this.metadata=i||null}}function Ed(n,t){let e=null;try{e=n.getResponseHeader("X-Goog-Upload-Status")}catch{In(!1)}return In(!!e&&(t||["active"]).indexOf(e)!==-1),e}function gI(n,t,e,s,i){const r=t.bucketOnlyServerUrl(),o=ry(t,s,i),a={name:o.fullPath},c=eo(r,n.host,n._protocol),l="POST",d={"X-Goog-Upload-Protocol":"resumable","X-Goog-Upload-Command":"start","X-Goog-Upload-Header-Content-Length":`${s.size()}`,"X-Goog-Upload-Header-Content-Type":o.contentType,"Content-Type":"application/json; charset=utf-8"},h=sy(o,e),f=n.maxUploadRetryTime;function m(b){Ed(b);let v;try{v=b.getResponseHeader("X-Goog-Upload-URL")}catch{In(!1)}return In(vc(v)),v}const _=new Si(c,l,m,f);return _.urlParams=a,_.headers=d,_.body=h,_.errorHandler=no(t),_}function _I(n,t,e,s){const i={"X-Goog-Upload-Command":"query"};function r(l){const d=Ed(l,["active","final"]);let h=null;try{h=l.getResponseHeader("X-Goog-Upload-Size-Received")}catch{In(!1)}h||In(!1);const f=Number(h);return In(!isNaN(f)),new La(f,s.size(),d==="final")}const o="POST",a=n.maxUploadRetryTime,c=new Si(e,o,r,a);return c.headers=i,c.errorHandler=no(t),c}const tp=256*1024;function yI(n,t,e,s,i,r,o,a){const c=new La(0,0);if(o?(c.current=o.current,c.total=o.total):(c.current=0,c.total=s.size()),s.size()!==c.total)throw OT();const l=c.total-c.current;let d=l;i>0&&(d=Math.min(d,i));const h=c.current,f=h+d;let m="";d===0?m="finalize":l===d?m="upload, finalize":m="upload";const _={"X-Goog-Upload-Command":m,"X-Goog-Upload-Offset":`${c.current}`},b=s.slice(h,f);if(b===null)throw q_();function v(S,O){const M=Ed(S,["active","final"]),E=c.current+d,y=s.size();let x;return M==="final"?x=xd(t,r)(S,O):x=null,new La(E,y,M==="final",x)}const T="POST",I=t.maxUploadRetryTime,C=new Si(e,T,v,I);return C.headers=_,C.body=b.uploadData(),C.progressCallback=a||null,C.errorHandler=no(n),C}const Ee={RUNNING:"running",PAUSED:"paused",SUCCESS:"success",CANCELED:"canceled",ERROR:"error"};function fl(n){switch(n){case"running":case"pausing":case"canceling":return Ee.RUNNING;case"paused":return Ee.PAUSED;case"success":return Ee.SUCCESS;case"canceled":return Ee.CANCELED;case"error":return Ee.ERROR;default:return Ee.ERROR}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Va=new Nu("@firebase/auth");function FI(n,...t){Va.logLevel<=nt.WARN&&Va.warn(`Auth (${Vs}): ${n}`,...t)}function ca(n,...t){Va.logLevel<=nt.ERROR&&Va.error(`Auth (${Vs}): ${n}`,...t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class so{constructor(t,e){this.shortDelay=t,this.longDelay=e,Pn(e>t,"Short delay should be less than long delay!"),this.isMobile=Kb()||Zb()}get(){return UI()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bn extends io{constructor(){super("google.com"),this.addScope("profile")}static credential(t,e){return Ms._fromParams({providerId:Bn.PROVIDER_ID,signInMethod:Bn.GOOGLE_SIGN_IN_METHOD,idToken:t,accessToken:e})}static credentialFromResult(t){return Bn.credentialFromTaggedObject(t)}static credentialFromError(t){return Bn.credentialFromTaggedObject(t.customData||{})}static credentialFromTaggedObject({_tokenResponse:t}){if(!t)return null;const{oauthIdToken:e,oauthAccessToken:s}=t;if(!e&&!s)return null;try{return Bn.credential(e,s)}catch{return null}}}Bn.GOOGLE_SIGN_IN_METHOD="google.com";Bn.PROVIDER_ID="google.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $n extends io{constructor(){super("twitter.com")}static credential(t,e){return Ms._fromParams({providerId:$n.PROVIDER_ID,signInMethod:$n.TWITTER_SIGN_IN_METHOD,oauthToken:t,oauthTokenSecret:e})}static credentialFromResult(t){return $n.credentialFromTaggedObject(t)}static credentialFromError(t){return $n.credentialFromTaggedObject(t.customData||{})}static credentialFromTaggedObject({_tokenResponse:t}){if(!t)return null;const{oauthAccessToken:e,oauthTokenSecret:s}=t;if(!e||!s)return null;try{return $n.credential(e,s)}catch{return null}}}$n.TWITTER_SIGN_IN_METHOD="twitter.com";$n.PROVIDER_ID="twitter.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
