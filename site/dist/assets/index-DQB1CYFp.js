 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cr=R0;function Mg(n,t={}){let e=n;typeof t!="object"&&(t={name:t});const s=Object.assign({name:hu,automaticDataCollectionEnabled:!1},t),r=s.name;if(typeof r!="string"||!r)throw ms.create("bad-app-name",{appName:String(r)});if(e||(e=kg()),!e)throw ms.create("no-options");const i=Ka.get(r);if(i){if(Ya(e,i.options)&&Ya(s,i.config))return i;throw ms.create("duplicate-app",{appName:r})}const o=new Bx(r);for(const c of fu.values())o.addComponent(c);const a=new O0(e,s,o);return Ka.set(r,a),a}function rd(n=hu){const t=Ka.get(n);if(!t&&n===hu&&kg())return Mg();if(!t)throw ms.create("no-app",{appName:n});return t}function bn(n,t,e){var s;let r=(s=P0[n])!==null&&s!==void 0?s:n;e&&(r+=`-${e}`);const i=r.match(/\s|\//),o=t.match(/\s|\//);if(i||o){const a=[`Unable to register library "${r}" with version "${t}":`];i&&a.push(`library name "${r}" contains illegal characters (whitespace or "/")`),i&&o&&a.push("and"),o&&a.push(`version name "${t}" contains illegal characters (whitespace or "/")`),Wn.warn(a.join(" "));return}Js(new ys(`${r}-version`,()=>({library:r,version:t}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function nt(n="Unexpected state"){const t=`FIRESTORE (${Jr}) INTERNAL ASSERTION FAILED: `+n;throw Gn(t),new Error(t)}function Ct(n,t){n||nt()}function it(n,t){return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $={OK:"ok",CANCELLED:"cancelled",UNKNOWN:"unknown",INVALID_ARGUMENT:"invalid-argument",DEADLINE_EXCEEDED:"deadline-exceeded",NOT_FOUND:"not-found",ALREADY_EXISTS:"already-exists",PERMISSION_DENIED:"permission-denied",UNAUTHENTICATED:"unauthenticated",RESOURCE_EXHAUSTED:"resource-exhausted",FAILED_PRECONDITION:"failed-precondition",ABORTED:"aborted",OUT_OF_RANGE:"out-of-range",UNIMPLEMENTED:"unimplemented",INTERNAL:"internal",UNAVAILABLE:"unavailable",DATA_LOSS:"data-loss"};class Y extends kn{constructor(t,e){super(t,e),this.code=t,this.message=e,this.toString=()=>`${this.name}: [code=${this.code}]: ${this.message}`}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mc{constructor(t,e,s,r,i){this.snapshotVersion=t,this.targetChanges=e,this.targetMismatches=s,this.documentUpdates=r,this.resolvedLimboDocuments=i}static createSynthesizedRemoteEventForCurrentChange(t,e,s){const r=new Map;return r.set(t,Ao.createSynthesizedTargetChangeForCurrentChange(t,e,s)),new Mc(st.min(),r,new Yt(vt),Yn(),ut())}}class Ao{constructor(t,e,s,r,i){this.resumeToken=t,this.current=e,this.addedDocuments=s,this.modifiedDocuments=r,this.removedDocuments=i}static createSynthesizedTargetChangeForCurrentChange(t,e,s){return new Ao(s,e,ut(),ut(),ut())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Oc(n){return new Yw(n,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class UE extends class{}{constructor(t,e,s,r){super(),this.authCredentials=t,this.appCheckCredentials=e,this.connection=s,this.serializer=r,this.y_=!1}w_(){if(this.y_)throw new Y($.FAILED_PRECONDITION,"The client has already been terminated.")}Mo(t,e,s,r){return this.w_(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([i,o])=>this.connection.Mo(t,xu(e,s),r,i,o)).catch(i=>{throw i.name==="FirebaseError"?(i.code===$.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),i):new Y($.UNKNOWN,i.toString())})}Lo(t,e,s,r,i){return this.w_(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([o,a])=>this.connection.Lo(t,xu(e,s),r,o,a,i)).catch(o=>{throw o.name==="FirebaseError"?(o.code===$.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),o):new Y($.UNKNOWN,o.toString())})}terminate(){this.y_=!0,this.connection.terminate()}}class jE{constructor(t,e){this.asyncQueue=t,this.onlineStateHandler=e,this.state="Unknown",this.S_=0,this.b_=null,this.D_=!0}v_(){this.S_===0&&(this.C_("Unknown"),this.b_=this.asyncQueue.enqueueAfterDelay("online_state_timeout",1e4,()=>(this.b_=null,this.F_("Backend didn't respond within 10 seconds."),this.C_("Offline"),Promise.resolve())))}M_(t){this.state==="Online"?this.C_("Unknown"):(this.S_++,this.S_>=1&&(this.x_(),this.F_(`Connection failed 1 times. Most recent error: ${t.toString()}`),this.C_("Offline")))}set(t){this.x_(),this.S_=0,t==="Online"&&(this.D_=!1),this.C_(t)}C_(t){t!==this.state&&(this.state=t,this.onlineStateHandler(t))}F_(t){const e=`Could not reach Cloud Firestore backend. ${t}
This typically indicates that your device does not have a healthy Internet connection at the moment. The client will operate in offline mode until it is able to successfully connect to the backend.`;this.D_?(Gn(e),this.D_=!1):K("OnlineStateTracker",e)}x_(){this.b_!==null&&(this.b_.cancel(),this.b_=null)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lr{constructor(t){this.comparator=t?(e,s)=>t(e,s)||X.comparator(e.key,s.key):(e,s)=>X.comparator(e.key,s.key),this.keyedMap=Mi(),this.sortedSet=new Yt(this.comparator)}static emptySet(t){return new Lr(t.comparator)}has(t){return this.keyedMap.get(t)!=null}get(t){return this.keyedMap.get(t)}first(){return this.sortedSet.minKey()}last(){return this.sortedSet.maxKey()}isEmpty(){return this.sortedSet.isEmpty()}indexOf(t){const e=this.keyedMap.get(t);return e?this.sortedSet.indexOf(e):-1}get size(){return this.sortedSet.size}forEach(t){this.sortedSet.inorderTraversal((e,s)=>(t(e),!1))}add(t){const e=this.delete(t.key);return e.copy(e.keyedMap.insert(t.key,t),e.sortedSet.insert(t,null))}delete(t){const e=this.get(t);return e?this.copy(this.keyedMap.remove(t),this.sortedSet.remove(e)):this}isEqual(t){if(!(t instanceof Lr)||this.size!==t.size)return!1;const e=this.sortedSet.getIterator(),s=t.sortedSet.getIterator();for(;e.hasNext();){const r=e.getNext().key,i=s.getNext().key;if(!r.isEqual(i))return!1}return!0}toString(){const t=[];return this.forEach(e=>{t.push(e.toString())}),t.length===0?"DocumentSet ()":`DocumentSet (
  `+t.join(`  
`)+`
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class z_{constructor(t){this.observer=t,this.muted=!1}next(t){this.muted||this.observer.next&&this.Ya(this.observer.next,t)}error(t){this.muted||(this.observer.error?this.Ya(this.observer.error,t):Gn("Uncaught Error in snapshot listener:",t.toString()))}Za(){this.muted=!0}Ya(t,e){setTimeout(()=>{this.muted||t(e)},0)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sr{constructor(t){this._byteString=t}static fromBase64String(t){try{return new sr(ye.fromBase64String(t))}catch(e){throw new Y($.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+e)}}static fromUint8Array(t){return new sr(ye.fromUint8Array(t))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(t){return this._byteString.isEqual(t._byteString)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Co{constructor(...t){for(let e=0;e<t.length;++e)if(t[e].length===0)throw new Y($.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new ge(t)}isEqual(t){return this._internalPath.isEqual(t._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Uc{constructor(t,e){if(!isFinite(t)||t<-90||t>90)throw new Y($.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+t);if(!isFinite(e)||e<-180||e>180)throw new Y($.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+e);this._lat=t,this._long=e}get latitude(){return this._lat}get longitude(){return this._long}isEqual(t){return this._lat===t._lat&&this._long===t._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(t){return vt(this._lat,t._lat)||vt(this._long,t._long)}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function VT(n){if(n.limitType==="L"&&n.explicitOrderBy.length===0)throw new Y($.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}class Md{}class Wc extends Md{}function Xt(n,t,...e){let s=[];t instanceof Md&&s.push(t),s=s.concat(e),function(i){const o=i.filter(c=>c instanceof Gc).length,a=i.filter(c=>c instanceof Po).length;if(o>1||o>0&&a>0)throw new Y($.INVALID_ARGUMENT,"InvalidQuery. When using composite filters, you cannot use more than one filter at the top level. Consider nesting the multiple filters within an `and(...)` statement. For example: change `query(query, where(...), or(...))` to `query(query, and(where(...), or(...)))`.")}(s);for(const r of s)n=r._apply(n);return n}class Po extends Wc{constructor(t,e,s){super(),this._field=t,this._op=e,this._value=s,this.type="where"}static _create(t,e,s){return new Po(t,e,s)}_apply(t){const e=this._parse(t);return ry(t._query,e),new Qn(t.firestore,t.converter,vu(t._query,e))}_parse(t){const e=zc(t.firestore);return function(i,o,a,c,l,d,h){let f;if(l.isKeyField()){if(d==="array-contains"||d==="array-contains-any")throw new Y($.INVALID_ARGUMENT,`Invalid Query. You can't perform '${d}' queries on documentId().`);if(d==="in"||d==="not-in"){hp(h,d);const m=[];for(const g of h)m.push(dp(c,i,g));f={arrayValue:{values:m}}}else f=dp(c,i,h)}else d!=="in"&&d!=="not-in"&&d!=="array-contains-any"||hp(h,d),f=OT(a,o,h,d==="in"||d==="not-in");return le.create(l,d,f)}(t._query,"where",e,t.firestore._databaseId,this._field,this._op,this._value)}}function Rt(n,t,e){const s=t,r=qc("where",n);return Po._create(r,s,e)}class Gc extends Md{constructor(t,e){super(),this.type=t,this._queryConstraints=e}static _create(t,e){return new Gc(t,e)}_parse(t){const e=this._queryConstraints.map(s=>s._parse(t)).filter(s=>s.getFilters().length>0);return e.length===1?e[0]:ln.create(e,this._getOperator())}_apply(t){const e=this._parse(t);return e.getFilters().length===0?t:(function(r,i){let o=r;const a=i.getFlattenedFilters();for(const c of a)ry(o,c),o=vu(o,c)}(t._query,e),new Qn(t.firestore,t.converter,vu(t._query,e)))}_getQueryConstraints(){return this._queryConstraints}_getOperator(){return this.type==="and"?"and":"or"}}class Yc extends Wc{constructor(t,e){super(),this._field=t,this._direction=e,this.type="orderBy"}static _create(t,e){return new Yc(t,e)}_apply(t){const e=function(r,i,o){if(r.startAt!==null)throw new Y($.INVALID_ARGUMENT,"Invalid query. You must not call startAt() or startAfter() before calling orderBy().");if(r.endAt!==null)throw new Y($.INVALID_ARGUMENT,"Invalid query. You must not call endAt() or endBefore() before calling orderBy().");return new ro(i,o)}(t._query,this._field,this._direction);return new Qn(t.firestore,t.converter,function(r,i){const o=r.explicitOrderBy.concat([i]);return new Zr(r.path,r.collectionGroup,o,r.filters.slice(),r.limit,r.limitType,r.startAt,r.endAt)}(t._query,e))}}function Od(n,t="asc"){const e=t,s=qc("orderBy",n);return Yc._create(s,e)}class Kc extends Wc{constructor(t,e,s){super(),this.type=t,this._limit=e,this._limitType=s}static _create(t,e,s){return new Kc(t,e,s)}_apply(t){return new Qn(t.firestore,t.converter,Ja(t._query,this._limit,this._limitType))}}function ic(n){return ST("limit",n),Kc._create("limit",n,"F")}function dp(n,t,e){if(typeof(e=Zt(e))=="string"){if(e==="")throw new Y($.INVALID_ARGUMENT,"Invalid query. When querying with documentId(), you must provide a valid document ID, but it was an empty string.");if(!Zg(t)&&e.indexOf("/")!==-1)throw new Y($.INVALID_ARGUMENT,`Invalid query. When querying a collection by documentId(), you must provide a plain document ID, but '${e}' contains a '/' character.`);const s=t.path.child(Vt.fromString(e));if(!X.isDocumentKey(s))throw new Y($.INVALID_ARGUMENT,`Invalid query. When querying a collection group by documentId(), the value provided must result in a valid document path, but '${s}' is not because it has an odd number of segments (${s.length}).`);return Mf(n,new X(s))}if(e instanceof De)return Mf(n,e._key);throw new Y($.INVALID_ARGUMENT,`Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: ${Vc(e)}.`)}function hp(n,t){if(!Array.isArray(n)||n.length===0)throw new Y($.INVALID_ARGUMENT,`Invalid Query. A non-empty array is required for '${t.toString()}' filters.`)}function ry(n,t){const e=function(r,i){for(const o of r)for(const a of o.getFlattenedFilters())if(i.indexOf(a.op)>=0)return a.op;return null}(n.filters,function(r){switch(r){case"!=":return["!=","not-in"];case"array-contains-any":case"in":return["not-in"];case"not-in":return["array-contains-any","in","not-in","!="];default:return[]}}(t.op));if(e!==null)throw e===t.op?new Y($.INVALID_ARGUMENT,`Invalid query. You cannot use more than one '${t.op.toString()}' filter.`):new Y($.INVALID_ARGUMENT,`Invalid query. You cannot use '${t.op.toString()}' filters with '${e.toString()}' filters.`)}class iy{convertValue(t,e="none"){switch(nr(t)){case 0:return null;case 1:return t.booleanValue;case 2:return se(t.integerValue||t.doubleValue);case 3:return this.convertTimestamp(t.timestampValue);case 4:return this.convertServerTimestamp(t,e);case 5:return t.stringValue;case 6:return this.convertBytes(er(t.bytesValue));case 7:return this.convertReference(t.referenceValue);case 8:return this.convertGeoPoint(t.geoPointValue);case 9:return this.convertArray(t.arrayValue,e);case 11:return this.convertObject(t.mapValue,e);case 10:return this.convertVectorValue(t.mapValue);default:throw nt()}}convertObject(t,e){return this.convertObjectMap(t.fields,e)}convertObjectMap(t,e="none"){const s={};return lr(t,(r,i)=>{s[r]=this.convertValue(i,e)}),s}convertVectorValue(t){var e,s,r;const i=(r=(s=(e=t.fields)===null||e===void 0?void 0:e.value.arrayValue)===null||s===void 0?void 0:s.values)===null||r===void 0?void 0:r.map(o=>se(o.doubleValue));return new jc(i)}convertGeoPoint(t){return new Uc(se(t.latitude),se(t.longitude))}convertArray(t,e){return(t.values||[]).map(s=>this.convertValue(s,e))}convertServerTimestamp(t,e){switch(e){case"previous":const s=ld(t);return s==null?null:this.convertValue(s,e);case"estimate":return this.convertTimestamp(no(t));default:return null}}convertTimestamp(t){const e=bs(t);return new Ht(e.seconds,e.nanos)}convertDocumentKey(t,e){const s=Vt.fromString(t);Ct(x_(s));const r=new jr(s.get(1),s.get(3)),i=new X(s.popFirst(5));return r.isEqual(e)||Gn(`Document ${i} contains a document reference within a different database (${r.projectId}/${r.database}) which is not supported. It will be treated as a reference in the current database (${e.projectId}/${e.database}) instead.`),i}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Mo(n,t,e){let s=t;return e==null&&(s=`https://${t}`),`${e}://${s}/v0${n}`}function gy(n){const t=encodeURIComponent;let e="?";for(const s in n)if(n.hasOwnProperty(s)){const r=t(s)+"="+t(n[s]);e=e+r+"&"}return e=e.slice(0,-1),e}var Gs;(function(n){n[n.NO_ERROR=0]="NO_ERROR",n[n.NETWORK_ERROR=1]="NETWORK_ERROR",n[n.ABORT=2]="ABORT"})(Gs||(Gs={}));/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Gy(n,t=[]){let e;switch(n){case"Browser":e=Tp(Me());break;case"Worker":e=`${Tp(Me())}-${n}`;break;default:e=n}const s=t.length?t.join(","):"FirebaseCore-web";return`${e}/JsCore/${cr}/${s}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function GA(n){switch(n){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function YA(n){const t=Ri(Pi(n)).link,e=t?Ri(Pi(t)).deep_link_id:null,s=Ri(Pi(n)).deep_link_id;return(s?Ri(Pi(s)).link:null)||s||e||t||n}class Yd{constructor(t){var e,s,r,i,o,a;const c=Ri(Pi(t)),l=(e=c.apiKey)!==null&&e!==void 0?e:null,d=(s=c.oobCode)!==null&&s!==void 0?s:null,h=GA((r=c.mode)!==null&&r!==void 0?r:null);et(l&&d&&h,"argument-error"),this.apiKey=l,this.operation=h,this.code=d,this.continueUrl=(i=c.continueUrl)!==null&&i!==void 0?i:null,this.languageCode=(o=c.languageCode)!==null&&o!==void 0?o:null,this.tenantId=(a=c.tenantId)!==null&&a!==void 0?a:null}static parseLink(t){const e=YA(t);try{return new Yd(e)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class si{constructor(){this.providerId=si.PROVIDER_ID}static credential(t,e){return lo._fromEmailAndPassword(t,e)}static credentialWithLink(t,e){const s=Yd.parseLink(e);return et(s,"argument-error"),lo._fromEmailAndCode(t,s.code,s.tenantId)}}si.PROVIDER_ID="password";si.EMAIL_PASSWORD_SIGN_IN_METHOD="password";si.EMAIL_LINK_SIGN_IN_METHOD="emailLink";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gr{constructor(t){this.user=t.user,this.providerId=t.providerId,this._tokenResponse=t._tokenResponse,this.operationType=t.operationType}static async _fromIdTokenResponse(t,e,s,r=!1){const i=await Fn._fromIdTokenResponse(t,s,r),o=kp(s);return new Gr({user:i,providerId:o,_tokenResponse:s,operationType:e})}static async _forOperation(t,e,s){await t._updateTokensIfNecessary(s,!0);const r=kp(s);return new Gr({user:t,providerId:r,_tokenResponse:s,operationType:e})}}function kp(n){return n.providerId?n.providerId:"phoneNumber"in n?"phone":null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Jy(n,t,e=!1){if(Ln(n.app))return Promise.reject(gs(n));const s="signIn",r=await Xy(n,s,t),i=await Gr._fromIdTokenResponse(n,s,r);return e||await n._updateCurrentUser(i.user),i}async function XA(n,t){return Jy(hr(n),t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zS=new No(5e3,15e3),HS="__/auth/iframe",qS="emulator/auth/iframe",WS={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},GS=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function YS(n){const t=n.config;et(t.authDomain,n,"auth-domain-config-required");const e=t.emulator?Hd(t,qS):`https://${n.config.authDomain}/${HS}`,s={apiKey:t.apiKey,appName:n.name,v:cr},r=GS.get(n.config.apiHost);r&&(s.eid=r);const i=n._getFrameworks();return i.length&&(s.fw=i.join(",")),`${e}?${wo(s).slice(1)}`}async function KS(n){const t=await jS(n),e=Tn().gapi;return et(e,n,"internal-error"),t.open({where:document.body,url:YS(n),messageHandlersFilter:e.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:WS,dontclear:!0},s=>new Promise(async(r,i)=>{await s.restyle({setHideOnLeave:!1});const o=En(n,"network-request-failed"),a=Tn().setTimeout(()=>{i(o)},zS.get());function c(){Tn().clearTimeout(a),r(s)}s.ping(c).then(c,()=>{i(o)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
                        ...
                        ${(n.comprasCriticas||[]).map(r=>`
                            <div class="p-4 hover:bg-canvas transition-colors flex items-center gap-4 border-l-4 ${r.criticidade==="alta"?"border-alert":r.criticidade==="media"?"border-amber-500":"border-blue-500"}">
                                ...
                                <div class="flex-shrink-0 text-2xl" title="${r.motivo}">
                                    ${r.criticidade==="alta"?"⚠️":r.criticidade==="media"?"⏳":"ℹ️"}
                                </div>
...
`);const a=new Blob([o],{type:"text/csv;charset=utf-8;"}),c=URL.createObjectURL(a),l=document.createElement("a");l.href=c,l.download=`compras_${n}_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(l),l.click(),document.body.removeChild(l),URL.revokeObjectURL(c)}},yg={getUsers:async()=>(await yt(mt(Z,"usuarios"))).docs.map(t=>({id:t.id,...t.data()})),updateUser:async(n,t)=>{await tn(ue(Z,"usuarios",n),t)},createUserProfile:async(n,t)=>{await ly(ue(Z,"usuarios",n),t)}},RO={render:n=>`
        ...
        `},renderDashboard:(n,t)=>{var i,o,a,c,l,d,h,f,m,g,b,y,I,k,E,R,P,M,w,v;const e=Number(n.horas_previstas||0),s=Number(n.horas_extras_previstas||0),r=e+s*1.5;return`
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ${F.createCard({title:"Total Orçado (Mat + M.O.)",content:`<p id="kpi-total-orcado" class="text-3xl font-display text-text">${J.formatCurrency(((o=(i=t.financialSummary)==null?void 0:i.total)==null?void 0:o.planned)||0)}</p>`})}
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-5 gap-6">
                        ...
                        ${F.createCard({title:"Horas Extras",content:`<p id="kpi-rdo-extras" class="text-4xl font-display text-alert uppercase">${(((k=t.rdoData)==null?void 0:k.totalExtras)||0).toFixed(1)}</p><p id="kpi-rdo-extras-sub" class="text-xs heading-muted mt-1">Orçado: ${(t.horasExtrasPrev??s).toFixed(1)}h</p>`,className:"border-l-4 border-alert"})}
                        ...
                        ${F.createCard({title:"Média Horas/Dia",content:`<p id="kpi-rdo-media-dia" class="text-4xl font-display text-text uppercase">${(((M=t.rdoData)==null?void 0:M.mediaHorasDia)||0).toFixed(1)}</p>`})}
                        ${F.createCard({title:"Total Funcionários",content:`<p id="kpi-rdo-func" class="text-4xl font-display text-text uppercase">${((w=t.rdoData)==null?void 0:w.totalFuncionarios)||0}</p>`})}
                    </div>
                        ...
                        <div class="overflow-x-auto">
                                ...
                                <tbody class="divide-y divide-border">
                                    ${(((v=t.rdoData)==null?void 0:v.diarios)||[]).map(x=>`
                                        <tr>
                                            <td class="px-2 py-2 text-center text-sm">${x.hasOcorrencia?`<span class="text-alert" title="${x.ocorrenciaTexto||"Ocorrência registrada"}">${Pt.alert}</span>`:""}</td>
                    ...
                    `,document.body.appendChild(P),(w=P.querySelectorAll("[data-close]"))==null||w.forEach(v=>v.addEventListener("click",()=>P.remove()));const M=P.querySelector("[data-edit-id]");M&&M.addEventListener("click",()=>{Mt.navigate(`/compras/${R.id}/editar`),P.remove()})};document.querySelectorAll('[data-action="edit-compra"]').forEach(R=>{R.addEventListener("click",()=>{const P=R.dataset.id;P&&Mt.navigate(`/compras/${P}/editar`)})}),document.querySelectorAll('[data-action="view-compra"]').forEach(R=>{R.addEventListener("click",()=>{const P=R.dataset.id,M=s.comprasRecentes.find(w=>w.id===P);M&&E(M)})})})();const I=()=>{const E=document.getElementById("calendar-wrapper"),R=document.getElementById("timeline-wrapper");E&&(E.innerHTML=Nr.render(m||s.comprasRecentes)),R&&(R.innerHTML=Nr.renderTimeline(s.comprasCalendar||s.comprasRecentes));const P=document.getElementById("cal-prev"),M=document.getElementById("cal-next");P==null||P.addEventListener("click",()=>{Nr.changeMonth(-1),I()}),M==null||M.addEventListener("click",()=>{Nr.changeMonth(1),I()})};I();const k=()=>{var R;const E=document.documentElement.classList.contains("theme-light");vg(E),Fs.renderCategorias("chart-categorias",s.gastosPorCategoria),Fs.renderStatusObra("chart-status-obra",s.porStatus),s.curvaS&&Fs.renderCurvaS("chart-curva-s",s.curvaS.labels||[],s.curvaS.planejado,s.curvaS.realizado),s.gastosDiarios&&Fs.renderGastosMensais("chart-gastos-diarios",s.gastosDiarios),s.ccTotais&&Fs.renderCentrosCusto("chart-cc",s.ccTotais),(s._pv||s._av)&&Fs.renderFinancePVAV("chart-finance-pvav",s._pv||[],s._av||[]),s.financialSummary&&Fs.renderFinanceComparison("chart-finance-compare",s.financialSummary),((R=s.rdoData)==null?void 0:R.totalHoras)>0?(jt.renderHorasNormaisExtras("chart-rdo-horas-normais-extras",s.rdoData.horasNormaisPorDia,s.rdoData.horasExtrasPorDia),s._plannedCurve&&s._executedCurve&&jt.renderCurvaHoras("chart-rdo-curva-horas",s._plannedCurve,s._executedCurve,s._feriados||[]),s.rdoData.horasPorFuncao&&jt.renderHorasPorFuncao("chart-rdo-funcao",s.rdoData.horasPorFuncao)):(jt.renderEmpty("chart-rdo-horas-normais-extras"),jt.renderEmpty("chart-rdo-curva-horas"))};setTimeout(async()=>{var w,v;const{COST_PER_HOUR:E,COST_PER_OVERTIME_HOUR:R}=await uo(async()=>{const{COST_PER_HOUR:x,COST_PER_OVERTIME_HOUR:A}=await Promise.resolve().then(()=>FD);return{COST_PER_HOUR:x,COST_PER_OVERTIME_HOUR:A}},void 0),P=Mb({data_inicio:e.data_prevista_inicio,data_prevista_fim:e.data_prevista_fim,orcamento:e.valor_orcado}),M=Ob(s.comprasCalendar||s.comprasRecentes||[],((w=s.rdoData)==null?void 0:w.horasPorDia)||{},E,R);s._pv=P,s._av=M;try{const x=e.numero_os||e.numeroOS||e.id;if(x){const A=await on.getIntegratedDataForObra(x);if(A&&A.reports){const S=on.processRDOData(A.reports);if(S){if(s.rdoData=S,s.rdoOk=!0,!S.totalFuncionarios||S.totalFuncionarios===0){const Bt=new Set;Object.entries(S.horasPorFuncao||{}).forEach(([wt])=>{Bt.add(wt)}),S.totalFuncionarios=Bt.size}const D=(Bt,wt)=>{const Wt=document.getElementById(Bt);Wt&&(Wt.textContent=wt)},C=Number(e.horas_previstas||0),G=Number(e.horas_extras_previstas||0),U=C+1.5*G,W=Number(S.totalHoras||0)+.5*Number(S.totalExtras||0),N=U-W,B=Object.values(S.horasNormaisPorDia||{}).reduce((Bt,wt)=>Bt+wt,0),Q=Object.keys(S.horasNormaisPorDia||{}).sort((Bt,wt)=>new Date(wt)-new Date(Bt)).slice(0,7).reduce((Bt,wt)=>Bt+(S.horasNormaisPorDia[wt]||0),0),lt=((v=(S.diarios||[]).slice(-1)[0])==null?void 0:v.funcionarios)||0,at=lt>0?lt*9:S.mediaHorasDia||9,tt=at>0?N/at:0;S.ultimos7Normais=Q,S.totalNormais=B,S.saldoDias=tt,D("kpi-rdo-total",B.toFixed(1)),D("kpi-rdo-media-dia",S.mediaHorasDia.toFixed(1)),D("kpi-rdo-func",String(S.totalFuncionarios||0)),D("kpi-rdo-extras",S.totalExtras.toFixed(1)),D("kpi-rdo-saldo",N.toFixed(1));const ft=document.getElementById("kpi-rdo-total-sub");ft&&(ft.textContent=`${Q.toFixed(1)}h gastas na última semana`);const It=document.getElementById("kpi-rdo-extras-sub");It&&(It.textContent=`Orçado: ${G.toFixed(1)}h`);const Nt=document.getElementById("kpi-rdo-saldo-sub");if(Nt&&(Nt.textContent=`~${tt.toFixed(1)} dias`),f=(S.diarios||[]).map(Bt=>({date:Bt.data,descricao_compra:"RDO",fornecedorNome:"Mão de obra",type:"rdo"})),m=[...s.comprasCalendar||[],...f],I(),S.totalHoras>0){jt.renderHorasNormaisExtras("chart-rdo-horas-normais-extras",S.horasNormaisPorDia,S.horasExtrasPorDia);const Bt=[],wt=[],Wt=xg(e.data_prevista_inicio),ae=xg(e.data_prevista_fim);if(Wt&&ae&&!Number.isNaN(Wt)&&!Number.isNaN(ae)&&Wt<=ae&&U>0){const de=[],ne=new Date(Wt);ne.setHours(12,0,0,0);const At=new Date(ae);for(At.setDate(At.getDate()+1);ne<=At;){const Ne=ne.getDay();Ne!==0&&Ne!==6&&de.push(new Date(ne)),ne.setDate(ne.getDate()+1)}const Ut=de.length?U/de.length:0;let ve=0;de.forEach(Ne=>{ve+=Ut,Bt.push({x:new Date(Ne),y:Number(ve.toFixed(2))})})}const Be=Object.keys(S.horasPorDia||{}).sort((de,ne)=>new Date(de)-new Date(ne));let hn=0;Be.forEach(de=>{const ne=new Date(de);ne.setDate(ne.getDate()+1),ne.setHours(12,0,0,0),!Number.isNaN(ne.getTime())&&(hn+=S.horasPorDia[de],wt.push({x:ne,y:Number(hn.toFixed(2))}))});const Ue=on.getHolidays?on.getHolidays():[];if(s._plannedCurve=Bt,s._executedCurve=wt,s._feriados=Ue,jt.renderCurvaHoras("chart-rdo-curva-horas",Bt,wt,Ue),S.horasPorFuncao&&jt.renderHorasPorFuncao("chart-rdo-funcao",S.horasPorFuncao),jt.renderHorasStacked("chart-rdo-bateria",{plannedNormal:C,plannedExtra:G*1.5,execNormal:B,execExtra:S.totalExtras*1.5}),S.techHours){const de=Object.entries(S.techHours||{}).sort((Ut,ve)=>ve[1]-Ut[1]).slice(0,10),ne=S.techExtraHours||{},At=document.querySelector("#table-rdo-tech tbody");At&&(At.innerHTML=de.map(([Ut,ve])=>`
                                            ...
                                            <tr>
                                                <td class="px-2 py-2 text-center text-sm">
                                                    ${wt.hasOcorrencia?`<button class="text-alert underline" data-ocorrencia="${Be}" title="Ocorrência registrada">&#9888;</button>`:""}
                                                </td>
                                            ...
                                            `}).join(""),$e.querySelectorAll("[data-ocorrencia]").forEach(wt=>{wt.addEventListener("click",()=>{var Be;const Wt=wt.getAttribute("data-ocorrencia")||"Sem detalhes",ae=document.createElement("div");ae.className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4",ae.innerHTML=`
                                                ...
                                                `,document.body.appendChild(ae),(Be=ae.querySelectorAll("[data-close]"))==null||Be.forEach(hn=>hn.addEventListener("click",()=>ae.remove()))})})):$e.innerHTML='<tr><td colspan="6" class="px-4 py-4 text-center heading-muted">Sem dados</td></tr>'}}}else s.rdoData=s.rdoData||{totalHoras:0,totalExtras:0,mediaHorasDia:0,mediaFuncionariosDia:0,totalFuncionarios:0},jt.renderEmpty("chart-rdo-horas-normais-extras"),jt.renderEmpty("chart-rdo-curva-horas")}}catch(x){console.warn("Erro ao carregar dados RDO (legacy):",(x==null?void 0:x.message)||x),s.rdoData=s.rdoData||{totalHoras:0,totalExtras:0,mediaHorasDia:0,mediaFuncionariosDia:0,totalFuncionarios:0},jt.renderEmpty("chart-rdo-horas-normais-extras"),jt.renderEmpty("chart-rdo-curva-horas")}try{const x=await Ye.calculateFinancialSummary(e.id,s.comprasCalendar||s.comprasRecentes||[],s.rdoData||null);s.financialSummary=x,x!=null&&x.total&&(s.totalGasto=x.total.spent||0,s.economia=(x.total.planned||0)-(x.total.spent||0),s.curvaPercent=x.total.planned>0?x.total.spent/x.total.planned*100:0)}catch(x){console.warn("Erro ao calcular resumo financeiro",x)}b(),k()},100),Tt.subscribe(E=>{E!=null&&E.currentTheme&&requestAnimationFrame(()=>{setTimeout(k,0)})})}catch(e){console.error(e),Et.render(`<div class="text-red-500 p-4">Erro: ${e.message}</div>`)}},bindFormEvents:n=>{const t=document.getElementById("form-obra");t.addEventListener("submit",async e=>{e.preventDefault();const s=document.getElementById("btn-submit");try{s.disabled=!0,s.innerHTML=F.createLoader();const r=new FormData(t),i=Object.fromEntries(r.entries());i.valor_orcado=i.valor_orcado?Number(i.valor_orcado):0,i.tolerancia_percentual=i.tolerancia_percentual?Number(i.tolerancia_percentual)/100:0,i.valor_deslocamento_km=i.valor_deslocamento_km?Number(i.valor_deslocamento_km):0,i.horas_previstas=i.horas_previstas?Number(i.horas_previstas):0,i.horas_extras_previstas=i.horas_extras_previstas?Number(i.horas_extras_previstas):0,i.qtd_refeicoes=i.qtd_refeicoes?Number(i.qtd_refeicoes):0,i.qtd_hospedagens=i.qtd_hospedagens?Number(i.qtd_hospedagens):0,i.is_obra_filha=t.is_obra_filha.checked,n?(await Ye.updateObra(n,i),F.createToast("Obra atualizada com sucesso!")):(await Ye.createObra(i),F.createToast("Obra criada com sucesso!")),Mt.navigate("/obras")}catch(r){console.error(r),F.createToast("Erro ao salvar obra: "+r.message,"error"),s.disabled=!1,s.innerHTML=`<span>${n?"Salvar Alterações":"Criar Obra"}</span>`}})}},OO={renderMenu:()=>`
        <div class="space-y-4">
