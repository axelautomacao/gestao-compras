                                        ...
                                        <td class="px-6 py-4 text-sm text-right">
                                            ${w.id?`
                                                <div class="flex items-center justify-end gap-2">
                                                    <button class="text-text-muted hover:text-text" data-action="view-compra" data-id="${w.id}" title="Ver compra">${Dt.eye}</button>
                                                    <button class="text-primary hover:text-primary-strong" data-action="edit-compra" data-id="${w.id}" title="Editar compra">${Dt.pencil}</button>
                                                </div>
                                            `:"-"}
                                        </td>
                                    </tr>
